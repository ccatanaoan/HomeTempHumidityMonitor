...
public String  _class_globals() throws Exception{
 ...
 //BA.debugLineNum = 4;BA.debugLine="Private views As Map";
_views = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 5;BA.debugLine="Private stub As B4XView 'ignore this is required";
_stub = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 6;BA.debugLine="Private radius As Int = 10dip";
_radius = __c.DipToCurrent((int) (10));
 //BA.debugLineNum = 7;BA.debugLine="Private animationDuration As Int = 500";
_animationduration = (int) (500);
 //BA.debugLineNum = 8;BA.debugLine="Private cx, cy As Float";
_cx = 0f;
_cy = 0f;
 //BA.debugLineNum = 9;BA.debugLine="Private xui As XUI";
_xui = new anywheresoftware.b4a.objects.B4XViewWrapper.XUI();
 //BA.debugLineNum = 10;BA.debugLine="Private color As Int = xui.Color_Red";
_color = _xui.Color_Red;
 //BA.debugLineNum = 11;BA.debugLine="Private textColor As Int = xui.Color_White";
...
int _duration = 0;
 //BA.debugLineNum = 88;BA.debugLine="Private Sub CreateLabel(p As B4XView, count As Int";
 //BA.debugLineNum = 89;BA.debugLine="Dim lbl As Label";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 90;BA.debugLine="lbl.Initialize(\"\")";
_lbl.Initialize(ba,"");
 //BA.debugLineNum = 91;BA.debugLine="Dim xlbl As B4XView = lbl";
_xlbl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_xlbl.setObject((java.lang.Object)(_lbl.getObject()));
 //BA.debugLineNum = 92;BA.debugLine="xlbl.Font = xui.CreateDefaultBoldFont(14)";
_xlbl.setFont(_xui.CreateDefaultBoldFont((float) (14)));
 //BA.debugLineNum = 93;BA.debugLine="xlbl.TextColor = textColor";
_xlbl.setTextColor(_textcolor);
 //BA.debugLineNum = 94;BA.debugLine="xlbl.Text = count";
_xlbl.setText(BA.ObjectToCharSequence(_count));
 //BA.debugLineNum = 95;BA.debugLine="p.AddView(xlbl, radius, radius, 0, 0)";
_p.AddView((android.view.View)(_xlbl.getObject()),_radius,_radius,(int) (0),(int) (0));
 //BA.debugLineNum = 96;BA.debugLine="xlbl.SetTextAlignment(\"CENTER\", \"CENTER\")";
_xlbl.SetTextAlignment("CENTER","CENTER");
 //BA.debugLineNum = 97;BA.debugLine="Dim duration As Int = animationDuration";
_duration = _animationduration;
 //BA.debugLineNum = 98;BA.debugLine="xlbl.SetLayoutAnimated(duration, 0, 0, radius * 2";
_xlbl.SetLayoutAnimated(_duration,(int) (0),(int) (0),(int) (_radius*2),(int) (_radius*2));
 //BA.debugLineNum = 99;BA.debugLine="xlbl.Visible = False";
_xlbl.setVisible(__c.False);
 //BA.debugLineNum = 100;BA.debugLine="xlbl.SetVisibleAnimated(animationDuration, True)";
...
anywheresoftware.b4a.objects.B4XViewWrapper _parent = null;
 //BA.debugLineNum = 69;BA.debugLine="Private Sub CreateNewPanel(view As B4XView, count";
 //BA.debugLineNum = 73;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 75;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(ba,"");
 //BA.debugLineNum = 77;BA.debugLine="p.SetElevationAnimated(animationDuration, 8dip)";
_p.SetElevationAnimated(_animationduration,(float) (__c.DipToCurrent((int) (8))));
 //BA.debugLineNum = 79;BA.debugLine="Dim xp As B4XView = p";
_xp = new anywheresoftware.b4a.objects.B4XViewWrapper();
_xp.setObject((java.lang.Object)(_p.getObject()));
 //BA.debugLineNum = 80;BA.debugLine="xp.SetColorAndBorder(color, 0, color, radius)";
_xp.SetColorAndBorder(_color,(int) (0),_color,_radius);
 //BA.debugLineNum = 81;BA.debugLine="cx = view.Left + view.Width - radius";
_cx = (float) (_view.getLeft()+_view.getWidth()-_radius);
 //BA.debugLineNum = 82;BA.debugLine="cy = view.Top + radius";
_cy = (float) (_view.getTop()+_radius);
 //BA.debugLineNum = 83;BA.debugLine="Dim parent As B4XView = view.Parent";
_parent = new anywheresoftware.b4a.objects.B4XViewWrapper();
_parent = _view.getParent();
 //BA.debugLineNum = 84;BA.debugLine="parent.AddView(xp, cx, cy, 0, 0)";
...
anywheresoftware.b4a.objects.B4XViewWrapper _lbl = null;
 //BA.debugLineNum = 52;BA.debugLine="Public Sub GetBadge(view As B4XView) As Int";
 //BA.debugLineNum = 53;BA.debugLine="If views.ContainsKey(view) Then";
if (_views.ContainsKey((Object)(_view.getObject()))) { 
 //BA.debugLineNum = 54;BA.debugLine="Dim lbl As B4XView = GetLabel(GetPanel(view))";
_lbl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_lbl = _getlabel(_getpanel((Object)(_view.getObject())));
 //BA.debugLineNum = 55;BA.debugLine="Return lbl.Text";
if (true) return (int)(Double.parseDouble(_lbl.getText()));
 }else {
 //BA.debugLineNum = 57;BA.debugLine="Return 0";
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _getlabel(anywheresoftware.b4a.objects.B4XViewWrapper _panel) throws Exception{
 //BA.debugLineNum = 65;BA.debugLine="Private Sub GetLabel(panel As B4XView) As B4XView";
 //BA.debugLineNum = 66;BA.debugLine="Return panel.GetView(panel.NumberOfViews - 1)";
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _getpanel(Object _view) throws Exception{
 //BA.debugLineNum = 61;BA.debugLine="Private Sub GetPanel (view As Object) As B4XView";
 //BA.debugLineNum = 62;BA.debugLine="Return views.Get(view)";
...
//C
this.state = -1;
 //BA.debugLineNum = 36;BA.debugLine="Dim p As B4XView = GetPanel(view)";
_p = new anywheresoftware.b4a.objects.B4XViewWrapper();
_p = parent._getpanel((Object)(_view.getObject()));
 //BA.debugLineNum = 37;BA.debugLine="GetLabel(p).RemoveViewFromParent";
parent._getlabel(_p).RemoveViewFromParent();
 //BA.debugLineNum = 38;BA.debugLine="views.Remove(view)";
parent._views.Remove((Object)(_view.getObject()));
 //BA.debugLineNum = 39;BA.debugLine="p.SetLayoutAnimated(animationDuration, cx, cy, 0,";
_p.SetLayoutAnimated(parent._animationduration,(int) (parent._cx),(int) (parent._cy),(int) (0),(int) (0));
 //BA.debugLineNum = 40;BA.debugLine="Sleep(animationDuration)";
...
this.state = -1;
;
 //BA.debugLineNum = 41;BA.debugLine="p.RemoveViewFromParent";
...
//C
this.state = -1;
 //BA.debugLineNum = 45;BA.debugLine="Dim lbl As B4XView = GetLabel(GetPanel(view))";
_lbl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_lbl = parent._getlabel(parent._getpanel((Object)(_view.getObject())));
 //BA.debugLineNum = 46;BA.debugLine="lbl.SetLayoutAnimated(animationDuration / 2, radi";
_lbl.SetLayoutAnimated((int) (parent._animationduration/(double)2),(int) (parent._radius+parent.__c.DipToCurrent((int) (8))),(int) (0),(int) (parent._radius*2),(int) (parent._radius*2));
 //BA.debugLineNum = 47;BA.debugLine="CreateLabel(GetPanel(view), Badge)";
parent._createlabel(parent._getpanel((Object)(_view.getObject())),_badge);
 //BA.debugLineNum = 48;BA.debugLine="Sleep(animationDuration / 2)";
...
this.state = -1;
;
 //BA.debugLineNum = 49;BA.debugLine="lbl.RemoveViewFromParent";
...
anywheresoftware.b4a.objects.B4XViewWrapper _p = null;
 //BA.debugLineNum = 18;BA.debugLine="Public Sub SetBadge(view As B4XView, Badge As Int)";
 //BA.debugLineNum = 19;BA.debugLine="If views.ContainsKey(view) Then";
if (_views.ContainsKey((Object)(_view.getObject()))) { 
 //BA.debugLineNum = 20;BA.debugLine="If Badge = 0 Then";
if (_badge==0) { 
 //BA.debugLineNum = 21;BA.debugLine="RemoveBadge(view)";
_removebadge(_view);
 }else {
 //BA.debugLineNum = 23;BA.debugLine="ReplaceLabel(view, Badge)";
_replacelabel(_view,_badge);
 };
 }else {
 //BA.debugLineNum = 26;BA.debugLine="If Badge > 0 Then";
if (_badge>0) { 
 //BA.debugLineNum = 27;BA.debugLine="Dim p As B4XView = CreateNewPanel(view, Badge)";
_p = new anywheresoftware.b4a.objects.B4XViewWrapper();
_p = _createnewpanel(_view,_badge);
 //BA.debugLineNum = 28;BA.debugLine="CreateLabel(p, Badge)";
_createlabel(_p,_badge);
 //BA.debugLineNum = 29;BA.debugLine="p.SetLayoutAnimated(animationDuration, cx - rad";
_p.SetLayoutAnimated(_animationduration,(int) (_cx-_radius),(int) (_cy-_radius),(int) (_radius*2),(int) (_radius*2));
 //BA.debugLineNum = 30;BA.debugLine="views.Put(view, p)";
