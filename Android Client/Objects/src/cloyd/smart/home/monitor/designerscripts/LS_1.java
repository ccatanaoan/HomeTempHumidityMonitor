...
//BA.debugLineNum = 8;BA.debugLine="GaugeHeatIndex.top = lblComfort.Bottom + 20dip"[1/General script]
views.get("gaugeheatindex").vw.setTop((int)((views.get("lblcomfort").vw.getTop() + views.get("lblcomfort").vw.getHeight())+(20d * scale)));
//BA.debugLineNum = 9;BA.debugLine="GaugeHeatIndex.SetLeftAndRight(0dip,50%x)"[1/General script]
views.get("gaugeheatindex").vw.setLeft((int)((0d * scale)));
views.get("gaugeheatindex").vw.setWidth((int)((50d / 100 * width) - ((0d * scale))));
...
//BA.debugLineNum = 12;BA.debugLine="GaugeDewPoint.top = lblComfort.Bottom + 20dip"[1/General script]
views.get("gaugedewpoint").vw.setTop((int)((views.get("lblcomfort").vw.getTop() + views.get("lblcomfort").vw.getHeight())+(20d * scale)));
//BA.debugLineNum = 13;BA.debugLine="GaugeDewPoint.SetLeftAndRight(50%x,100%x)"[1/General script]
views.get("gaugedewpoint").vw.setLeft((int)((50d / 100 * width)));
views.get("gaugedewpoint").vw.setWidth((int)((100d / 100 * width) - ((50d / 100 * width))));
//BA.debugLineNum = 15;BA.debugLine="GaugeTemp.Width = 200dip"[1/General script]
views.get("gaugetemp").vw.setWidth((int)((200d * scale)));
//BA.debugLineNum = 16;BA.debugLine="GaugeTemp.top = GaugeHeatIndex.Bottom + 35dip"[1/General script]
views.get("gaugetemp").vw.setTop((int)((views.get("gaugeheatindex").vw.getTop() + views.get("gaugeheatindex").vw.getHeight())+(35d * scale)));
//BA.debugLineNum = 17;BA.debugLine="GaugeTemp.SetLeftAndRight(0dip,50%x)"[1/General script]
views.get("gaugetemp").vw.setLeft((int)((0d * scale)));
views.get("gaugetemp").vw.setWidth((int)((50d / 100 * width) - ((0d * scale))));
...
//BA.debugLineNum = 20;BA.debugLine="GaugeHumidity.top = GaugeHeatIndex.Bottom + 35dip"[1/General script]
views.get("gaugehumidity").vw.setTop((int)((views.get("gaugeheatindex").vw.getTop() + views.get("gaugeheatindex").vw.getHeight())+(35d * scale)));
//BA.debugLineNum = 21;BA.debugLine="GaugeHumidity.SetLeftAndRight(50%x,100%x)"[1/General script]
views.get("gaugehumidity").vw.setLeft((int)((50d / 100 * width)));
views.get("gaugehumidity").vw.setWidth((int)((100d / 100 * width) - ((50d / 100 * width))));
