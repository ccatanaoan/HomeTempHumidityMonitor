...
__c.LogImpl("38716299",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("38454198",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("38781837",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
