...
__c.LogImpl("231719435",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("231457334",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("231784973",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
