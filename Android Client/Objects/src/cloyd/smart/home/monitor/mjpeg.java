...
__c.LogImpl("88323083",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("88060982",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("88388621",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
