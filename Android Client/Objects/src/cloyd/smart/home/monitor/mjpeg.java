...
__c.LogImpl("18716299",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("18454198",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("18781837",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
