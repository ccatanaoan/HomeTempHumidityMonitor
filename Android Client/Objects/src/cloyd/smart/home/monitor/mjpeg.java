...
__c.LogImpl("78716299",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("78454198",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("78781837",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
