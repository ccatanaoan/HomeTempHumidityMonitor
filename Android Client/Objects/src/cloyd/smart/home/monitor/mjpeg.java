...
__c.LogImpl("68716299",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("68454198",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("68781837",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
