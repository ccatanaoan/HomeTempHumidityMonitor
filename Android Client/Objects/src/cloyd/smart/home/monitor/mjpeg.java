...
__c.LogImpl("631719435",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("631457334",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("631784973",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
