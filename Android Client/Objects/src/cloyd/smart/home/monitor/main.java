...
public static String  _activity_createmenu(de.amberhome.objects.appcompat.ACMenuWrapper _menu) throws Exception{
 //BA.debugLineNum = 475;BA.debugLine="Sub Activity_Createmenu(Menu As ACMenu)";
 //BA.debugLineNum = 476;BA.debugLine="Try";
try { //BA.debugLineNum = 477;BA.debugLine="Menu.Clear";
_menu.Clear();
 //BA.debugLineNum = 478;BA.debugLine="gblACMenu = Menu";
mostCurrent._gblacmenu = _menu;
 //BA.debugLineNum = 479;BA.debugLine="Menu.Add(0, 0, \"Enable Notification Listener\",Nu";
_menu.Add((int) (0),(int) (0),BA.ObjectToCharSequence("Enable Notification Listener"),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 480;BA.debugLine="Menu.Add(0, 0, \"Restart board\",Null)";
_menu.Add((int) (0),(int) (0),BA.ObjectToCharSequence("Restart board"),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 481;BA.debugLine="Menu.Add(0, 0, \"About\",Null)";
_menu.Add((int) (0),(int) (0),BA.ObjectToCharSequence("About"),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null));
 } 
       catch (Exception e8) {
			processBA.setLastException(e8); //BA.debugLineNum = 483;BA.debugLine="Log(LastException)";
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 543;BA.debugLine="If TabStrip1.CurrentPage = 2 Then";
if (mostCurrent._tabstrip1.getCurrentPage()==2) { 
 //BA.debugLineNum = 544;BA.debugLine="If WebView1.Url.Contains(\"cloyd.mynetgear.com:8";
if (mostCurrent._webview1.getUrl().contains("cloyd.mynetgear.com:82")) { 
 //BA.debugLineNum = 545;BA.debugLine="TabStrip1.ScrollTo(1,True)";
mostCurrent._tabstrip1.ScrollTo((int) (1),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 546;BA.debugLine="TabStrip1_PageSelected(1)";
_tabstrip1_pageselected((int) (1));
 //BA.debugLineNum = 547;BA.debugLine="Return True";
if (true) return anywheresoftware.b4a.keywords.Common.True;
 }else {
 //BA.debugLineNum = 549;BA.debugLine="If WebView1.IsInitialized = False Then";
if (mostCurrent._webview1.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 550;BA.debugLine="WebView1.Initialize(\"WebView1\")";
mostCurrent._webview1.Initialize(mostCurrent.activityBA,"WebView1");
 };
 //BA.debugLineNum = 552;BA.debugLine="DSBottomNavigationView1.CheckedItem=1";
...
if (true) return anywheresoftware.b4a.keywords.Common.True;
 ...
 //BA.debugLineNum = 557;BA.debugLine="TabStrip1.ScrollTo(0,True)";
mostCurrent._tabstrip1.ScrollTo((int) (0),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 558;BA.debugLine="TabStrip1_PageSelected(0)";
...
this.state = 4;
this.catchState = 65;
 //BA.debugLineNum = 375;BA.debugLine="If Item.Title = \"About\" Then";
if (true) break;
...
//C
this.state = 63;
 //BA.debugLineNum = 376;BA.debugLine="ShowAboutMenu";
_showaboutmenu();
 if (true) break;
...
//C
this.state = 63;
 //BA.debugLineNum = 378;BA.debugLine="Dim In As Intent";
_in = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 379;BA.debugLine="In.Initialize(\"android.settings.ACTION_NOTIFICA";
_in.Initialize("android.settings.ACTION_NOTIFICATION_LISTENER_SETTINGS","");
 //BA.debugLineNum = 380;BA.debugLine="StartActivity(In)";
...
this.state = 14;
this.catchState = 61;
 //BA.debugLineNum = 383;BA.debugLine="Dim result As Int";
_result = 0;
 //BA.debugLineNum = 384;BA.debugLine="Dim bd As BitmapDrawable";
_bd = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 385;BA.debugLine="bd.Initialize(LoadBitmapResize(File.DirAssets,";
_bd.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"0.png",anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (32)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (32)),anywheresoftware.b4a.keywords.Common.True).getObject()));
 //BA.debugLineNum = 386;BA.debugLine="If TabStrip1.CurrentPage = 2 Then";
if (true) break;
...
//C
this.state = 17;
 //BA.debugLineNum = 387;BA.debugLine="If WebView1.Url.Contains(\"cloyd.mynetgear.com";
if (true) break;
...
//C
this.state = 20;
 //BA.debugLineNum = 388;BA.debugLine="result = Msgbox2(\"Restart the main door CAME";
_result = anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence("Restart the main door CAMERA controller?"),BA.ObjectToCharSequence("Smart Home Monitor"),"Yes","","No",_bd.getBitmap(),mostCurrent.activityBA);
 //BA.debugLineNum = 389;BA.debugLine="If result = DialogResponse.POSITIVE Then";
if (true) break;
...
//C
this.state = 23;
 //BA.debugLineNum = 390;BA.debugLine="WebView1.StopLoading";
parent.mostCurrent._webview1.StopLoading();
 //BA.debugLineNum = 391;BA.debugLine="WebView1.RemoveView";
parent.mostCurrent._webview1.RemoveView();
 //BA.debugLineNum = 392;BA.debugLine="Dim j As HttpJob";
_j = new anywheresoftware.b4a.samples.httputils2.httpjob();
 //BA.debugLineNum = 393;BA.debugLine="j.Initialize(\"\", Me)";
_j._initialize(processBA,"",main.getObject());
 //BA.debugLineNum = 394;BA.debugLine="j.PostString(\"http://cloyd.mynetgear.com:82";
_j._poststring("http://cloyd.mynetgear.com:82/restart","");
 //BA.debugLineNum = 395;BA.debugLine="j.GetRequest.Timeout = 1500";
_j._getrequest().setTimeout((int) (1500));
 //BA.debugLineNum = 396;BA.debugLine="j.Username = \"admin\"";
_j._username = "admin";
 //BA.debugLineNum = 397;BA.debugLine="j.Password = \"960124\"";
_j._password = "960124";
...
//C
this.state = 30;
 //BA.debugLineNum = 407;BA.debugLine="result = Msgbox2(\"Restart the kitchen CAMERA";
...
_j._getrequest().setTimeout((int) (1500));
 //BA.debugLineNum = 415;BA.debugLine="j.Username = \"admin\"";
_j._username = "admin";
 //BA.debugLineNum = 416;BA.debugLine="j.Password = \"960124\"";
_j._password = "960124";
...
//C
this.state = 36;
 //BA.debugLineNum = 419;BA.debugLine="Log(j.GetString)";
anywheresoftware.b4a.keywords.Common.Log(_j._getstring());
 if (true) break;
...
_j._release();
 //BA.debugLineNum = 422;BA.debugLine="WebView1.Initialize(\"WebView1\")";
parent.mostCurrent._webview1.Initialize(mostCurrent.activityBA,"WebView1");
 //BA.debugLineNum = 423;BA.debugLine="DSBottomNavigationView1.CheckedItem=1";
...
//C
this.state = 41;
 //BA.debugLineNum = 427;BA.debugLine="result = Msgbox2(\"Restart the AIR QUALITY con";
...
this.state = 48;
;
 //BA.debugLineNum = 432;BA.debugLine="MQTT.Publish(\"MQ7\", bc.StringToBytes(\"Restar";
...
//C
this.state = 51;
 //BA.debugLineNum = 435;BA.debugLine="result = Msgbox2(\"Restart the WEATHER control";
_result = anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence("Restart the WEATHER controller?"),BA.ObjectToCharSequence("Smart Home Monitor"),"Yes","","No",_bd.getBitmap(),mostCurrent.activityBA);
 //BA.debugLineNum = 436;BA.debugLine="If result = DialogResponse.POSITIVE Then";
if (true) break;
...
//C
this.state = 54;
 //BA.debugLineNum = 437;BA.debugLine="If MQTT.IsInitialized = False Or MQTT.Connec";
if (true) break;
...
//C
this.state = 57;
 //BA.debugLineNum = 438;BA.debugLine="MQTT_Connect";
_mqtt_connect();
 if (true) break;
...
this.state = 58;
;
 //BA.debugLineNum = 440;BA.debugLine="MQTT.Publish(\"TempHumid\", bc.StringToBytes(\"";
...
this.state = 62;
this.catchState = 65;
 //BA.debugLineNum = 444;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)));
 if (true) break;
if (true) break;
...
b4a.example.dateutils._period _p = null;
 //BA.debugLineNum = 582;BA.debugLine="Sub CheckAirQualitySetting";
 //BA.debugLineNum = 583;BA.debugLine="Try";
try { //BA.debugLineNum = 584;BA.debugLine="If lblAirQuality.Text.Contains(\"Waiting for data";
...
_cs.Initialize();
 //BA.debugLineNum = 587;BA.debugLine="Dim a() As String = Regex.Split(\"\\|\",StateManag";
_a = anywheresoftware.b4a.keywords.Common.Regex.Split("\\|",mostCurrent._statemanager._getsetting(mostCurrent.activityBA,"AirQuality"));
 //BA.debugLineNum = 588;BA.debugLine="If a.Length = 3 Then";
if (_a.length==3) { 
 //BA.debugLineNum = 589;BA.debugLine="If IsNumber(a(0)) And a(0) > 0 Then";
if (anywheresoftware.b4a.keywords.Common.IsNumber(_a[(int) (0)]) && (double)(Double.parseDouble(_a[(int) (0)]))>0) { 
 //BA.debugLineNum = 590;BA.debugLine="GaugeAirQuality.CurrentValue = a(0)";
mostCurrent._gaugeairquality._setcurrentvalue((float)(Double.parseDouble(_a[(int) (0)])));
 //BA.debugLineNum = 591;BA.debugLine="lblAirQuality.Text = cs.Initialize.Bold.Appen";
mostCurrent._lblairquality.setText(BA.ObjectToCharSequence(_cs.Initialize().Bold().Append(BA.ObjectToCharSequence("Air Quality: ")).Pop().Append(BA.ObjectToCharSequence(_getairquality((int)(Double.parseDouble(_a[(int) (0)]))))).PopAll().getObject()));
 //BA.debugLineNum = 592;BA.debugLine="DateTime.DateFormat = \"yy-MM-dd HH:mm:ss z\"";
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("yy-MM-dd HH:mm:ss z");
 //BA.debugLineNum = 593;BA.debugLine="Dim ticks As Long = DateTime.DateParse(a(1) &";
_ticks = anywheresoftware.b4a.keywords.Common.DateTime.DateParse(_a[(int) (1)]+" "+_a[(int) (2)]+" GMT");
 //BA.debugLineNum = 594;BA.debugLine="DateTime.DateFormat = \"MMM d, yyyy h:mm:ss a";
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("MMM d, yyyy h:mm:ss a z");
 //BA.debugLineNum = 595;BA.debugLine="Dim lngTicks As Long = ticks";
_lngticks = _ticks;
 //BA.debugLineNum = 596;BA.debugLine="Dim p As Period = DateUtils.PeriodBetween(lng";
_p = mostCurrent._dateutils._periodbetween(mostCurrent.activityBA,_lngticks,anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 597;BA.debugLine="Log(\"AirQuality Time difference: \" & p.Minute";
anywheresoftware.b4a.keywords.Common.Log("AirQuality Time difference: "+BA.NumberToString(_p.Minutes)+" minutes"+BA.NumberToString(_p.Seconds)+" seconds");
 //BA.debugLineNum = 598;BA.debugLine="If p.Minutes > = 5 Then";
if (_p.Minutes>=5) { 
 //BA.debugLineNum = 599;BA.debugLine="lblAirQualityLastUpdate.Text = cs.Initialize";
...
mostCurrent._lblairqualitylastupdate.setText(BA.ObjectToCharSequence(_cs.Initialize().Bold().Append(BA.ObjectToCharSequence("Last update: ")).Pop().Color(anywheresoftware.b4a.keywords.Common.Colors.Red).Append(BA.ObjectToCharSequence(mostCurrent._lblairqualitylastupdate.getText().replace("Last update: ",""))).PopAll().getObject()));
			...
			processBA.setLastException(e27); //BA.debugLineNum = 609;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)));
 };
...
long _lngticks = 0L;
b4a.example.dateutils._period _p = null;
 //BA.debugLineNum = 613;BA.debugLine="Sub CheckTempHumiditySetting";
 //BA.debugLineNum = 614;BA.debugLine="Try";
try { //BA.debugLineNum = 615;BA.debugLine="If lblPerception.Text.Contains(\"Waiting for data";
if (mostCurrent._lblperception.getText().contains("Waiting for data...")) { 
 //BA.debugLineNum = 616;BA.debugLine="Dim cs As CSBuilder";
_cs = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 617;BA.debugLine="cs.Initialize";
_cs.Initialize();
 //BA.debugLineNum = 618;BA.debugLine="Dim a() As String = Regex.Split(\"\\|\",StateManag";
...
mostCurrent._gaugehumidity._setcurrentvalue((float)(Double.parseDouble(_a[(int) (2)])));
 //BA.debugLineNum = 625;BA.debugLine="lblPerception.Text = cs.Initialize.Bold.Appen";
mostCurrent._lblperception.setText(BA.ObjectToCharSequence(_cs.Initialize().Bold().Append(BA.ObjectToCharSequence("Human Perception: ")).Pop().Append(BA.ObjectToCharSequence(_getperception(_a[(int) (3)]))).PopAll().getObject()));
 //BA.debugLineNum = 626;BA.debugLine="lblComfort.Text = cs.Initialize.Bold.Append(\"";
...
_ticks = anywheresoftware.b4a.keywords.Common.DateTime.DateParse(_a[(int) (7)]+" "+_a[(int) (8)]+" GMT");
 //BA.debugLineNum = 631;BA.debugLine="DateTime.DateFormat = \"MMM d, yyyy h:mm:ss a";
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("MMM d, yyyy h:mm:ss a z");
 //BA.debugLineNum = 632;BA.debugLine="Dim lngTicks As Long = ticks";
_lngticks = _ticks;
 //BA.debugLineNum = 633;BA.debugLine="Dim p As Period = DateUtils.PeriodBetween(lng";
_p = mostCurrent._dateutils._periodbetween(mostCurrent.activityBA,_lngticks,anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 634;BA.debugLine="Log(\"TempHumidity Time difference: \" & p.Minu";
...
if (_p.Minutes>=5) { 
 //BA.debugLineNum = 636;BA.debugLine="lblLastUpdate.Text = cs.Initialize.Bold.Appe";
mostCurrent._lbllastupdate.setText(BA.ObjectToCharSequence(_cs.Initialize().Bold().Append(BA.ObjectToCharSequence("Last update: ")).Pop().Color(anywheresoftware.b4a.keywords.Common.Colors.Red).Append(BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.DateTime.Date(_lngticks))).PopAll().getObject()));
 ...
 //BA.debugLineNum = 638;BA.debugLine="lblLastUpdate.Text = cs.Initialize.Bold.Appe";
mostCurrent._lbllastupdate.setText(BA.ObjectToCharSequence(_cs.Initialize().Bold().Append(BA.ObjectToCharSequence("Last update: ")).Pop().Append(BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.DateTime.Date(_lngticks))).PopAll().getObject()));
 ...
 //BA.debugLineNum = 641;BA.debugLine="lblLastUpdate.Text = cs.Initialize.Bold.Appen";
mostCurrent._lbllastupdate.setText(BA.ObjectToCharSequence(_cs.Initialize().Bold().Append(BA.ObjectToCharSequence("Last update: ")).Pop().Color(anywheresoftware.b4a.keywords.Common.Colors.Red).Append(BA.ObjectToCharSequence(mostCurrent._lbllastupdate.getText().replace("Last update: ",""))).PopAll().getObject()));
			...
			processBA.setLastException(e33); //BA.debugLineNum = 646;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)));
 };
...
public static String  _dsbottomnavigationview1_navigationitemselected(de.amberhome.objects.appcompat.ACMenuItemWrapper _menuitem) throws Exception{
 //BA.debugLineNum = 650;BA.debugLine="Sub DSBottomNavigationView1_NavigationItemSelected";
 //BA.debugLineNum = 651;BA.debugLine="WebView1.StopLoading";
mostCurrent._webview1.StopLoading();
 //BA.debugLineNum = 652;BA.debugLine="WebView1.RemoveView";
mostCurrent._webview1.RemoveView();
 //BA.debugLineNum = 653;BA.debugLine="WebView1.JavaScriptEnabled = True";
mostCurrent._webview1.setJavaScriptEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 654;BA.debugLine="Activity.addview(WebView1,0dip,108dip,100%x,Panel";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._webview1.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (108)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),mostCurrent._panelwebview.getHeight());
 //BA.debugLineNum = 655;BA.debugLine="Select MenuItem.Id";
switch (BA.switchObjectToInt(_menuitem.getId(),(int) (1),(int) (2))) {
case 0: {
 //BA.debugLineNum = 657;BA.debugLine="WebView1.LoadHtml($\"<div> 			<table width=\"100%";
mostCurrent._webview1.LoadHtml(("<div>\n"+"			<table width=\"100%\" height=\"100%\" align=\"center\" valign=\"center\">\n"+"			<tr><td align=\"middle\">\n"+"					Waiting for the main door camera feed...\n"+"			</td></tr>\n"+"			</table>\n"+"			</div>"));
 //BA.debugLineNum = 664;BA.debugLine="WebView1.LoadURL(\"http://cloyd.mynetgear.com:82";
mostCurrent._webview1.LoadUrl("http://cloyd.mynetgear.com:82/stream");
 break; }
case 1: {
 //BA.debugLineNum = 666;BA.debugLine="WebView1.LoadHtml($\"<div> 			<table width=\"100%";
mostCurrent._webview1.LoadHtml(("<div>\n"+"			<table width=\"100%\" height=\"100%\" align=\"center\" valign=\"center\">\n"+"			<tr><td align=\"middle\">\n"+"					Waiting for the kitchen camera feed...\n"+"			</td></tr>\n"+"			</table>\n"+"			</div>"));
 //BA.debugLineNum = 673;BA.debugLine="WebView1.LoadURL(\"http://cloyd.mynetgear.com/st";
...
public static String  _getairquality(int _number) throws Exception{
 //BA.debugLineNum = 297;BA.debugLine="Sub GetAirQuality(number As Int) As String";
 //BA.debugLineNum = 300;BA.debugLine="If number <= 100 Then";
if (_number<=100) { 
 //BA.debugLineNum = 301;BA.debugLine="Return(\"Carbon monoxide perfect\")";
if (true) return ("Carbon monoxide perfect");
 }else if(((_number>100) && (_number<400)) || _number==400) { 
 //BA.debugLineNum = 303;BA.debugLine="Return(\"Carbon monoxide normal\")";
if (true) return ("Carbon monoxide normal");
 }else if(((_number>400) && (_number<900)) || _number==900) { 
 //BA.debugLineNum = 305;BA.debugLine="Return(\"Carbon monoxide high\")";
if (true) return ("Carbon monoxide high");
 }else if(_number>900) { 
 //BA.debugLineNum = 307;BA.debugLine="Return(\"ALARM Carbon monoxide very high\")";
if (true) return ("ALARM Carbon monoxide very high");
 }else {
 //BA.debugLineNum = 309;BA.debugLine="Return(\"MQ-7 - cant read any value - check the s";
...
anywheresoftware.b4a.objects.ConcreteViewWrapper _v = null;
 //BA.debugLineNum = 528;BA.debugLine="Public Sub GetAllTabLabels (tabstrip As TabStrip)";
 //BA.debugLineNum = 529;BA.debugLine="Dim jo As JavaObject = tabstrip";
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo.setObject((java.lang.Object)(_tabstrip));
 //BA.debugLineNum = 530;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 531;BA.debugLine="r.Target = jo.GetField(\"tabStrip\")";
_r.Target = _jo.GetField("tabStrip");
 //BA.debugLineNum = 532;BA.debugLine="Dim tc As Panel = r.GetField(\"tabsContainer\")";
_tc = new anywheresoftware.b4a.objects.PanelWrapper();
_tc.setObject((android.view.ViewGroup)(_r.GetField("tabsContainer")));
 //BA.debugLineNum = 533;BA.debugLine="Dim res As List";
_res = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 534;BA.debugLine="res.Initialize";
_res.Initialize();
 //BA.debugLineNum = 535;BA.debugLine="For Each v As View In tc";
_v = new anywheresoftware.b4a.objects.ConcreteViewWrapper();
{
...
_v.setObject((android.view.View)(group7.Get(index7)));
 //BA.debugLineNum = 536;BA.debugLine="If v Is Label Then res.Add(v)";
if (_v.getObjectOrNull() instanceof android.widget.TextView) { 
_res.Add((Object)(_v.getObject()));};
 }
};
 //BA.debugLineNum = 538;BA.debugLine="Return res";
if (true) return _res;
...
String _packagename = "";
 //BA.debugLineNum = 462;BA.debugLine="Sub GetVersionCode() As String";
 //BA.debugLineNum = 463;BA.debugLine="Dim AppVersion As String";
_appversion = "";
 //BA.debugLineNum = 464;BA.debugLine="Try";
try { //BA.debugLineNum = 465;BA.debugLine="Dim pm As PackageManager";
_pm = new anywheresoftware.b4a.phone.PackageManagerWrapper();
 //BA.debugLineNum = 466;BA.debugLine="Dim packageName As String";
_packagename = "";
 //BA.debugLineNum = 467;BA.debugLine="packageName =  Application.PackageName";
_packagename = anywheresoftware.b4a.keywords.Common.Application.getPackageName();
 //BA.debugLineNum = 468;BA.debugLine="AppVersion = pm.GetVersionName(packageName)";
_appversion = _pm.GetVersionName(_packagename);
 } 
       catch (Exception e8) {
			processBA.setLastException(e8); //BA.debugLineNum = 470;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)));
 };
 //BA.debugLineNum = 472;BA.debugLine="Return AppVersion";
...
public static String  _hideping() throws Exception{
 //BA.debugLineNum = 487;BA.debugLine="Private Sub HidePing";
 //BA.debugLineNum = 488;BA.debugLine="lblPing.SetVisibleAnimated(200, False)";
...
_p = mostCurrent._dateutils._periodbetween(mostCurrent.activityBA,_lngticks,anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 254;BA.debugLine="If p.Minutes > = 5 Then";
if (_p.Minutes>=5) { 
 //BA.debugLineNum = 255;BA.debugLine="lblLastUpdate.Text = cs.Initialize.Bold.Appe";
mostCurrent._lbllastupdate.setText(BA.ObjectToCharSequence(_cs.Initialize().Bold().Append(BA.ObjectToCharSequence("Last update: ")).Pop().Color(anywheresoftware.b4a.keywords.Common.Colors.Red).Append(BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.DateTime.Date(_lngticks))).PopAll().getObject()));
 }else {
 //BA.debugLineNum = 257;BA.debugLine="lblLastUpdate.Text = cs.Initialize.Bold.Appe";
mostCurrent._lbllastupdate.setText(BA.ObjectToCharSequence(_cs.Initialize().Bold().Append(BA.ObjectToCharSequence("Last update: ")).Pop().Append(BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.DateTime.Date(_lngticks))).PopAll().getObject()));
 };
 }else if((_a[(int) (8)]).equals("00:00:00")) { 
...
_lngticks = _ticks;
 //BA.debugLineNum = 279;BA.debugLine="Dim p As Period = DateUtils.PeriodBetween(lng";
_p = mostCurrent._dateutils._periodbetween(mostCurrent.activityBA,_lngticks,anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 280;BA.debugLine="Log(\"AirQuality timestamp: \" & DateTime.Date(";
anywheresoftware.b4a.keywords.Common.Log("AirQuality timestamp: "+anywheresoftware.b4a.keywords.Common.DateTime.Date(_lngticks));
 //BA.debugLineNum = 281;BA.debugLine="If p.Minutes > = 5 Then";
if (_p.Minutes>=5) { 
 //BA.debugLineNum = 282;BA.debugLine="lblAirQualityLastUpdate.Text = cs.Initialize";
mostCurrent._lblairqualitylastupdate.setText(BA.ObjectToCharSequence(_cs.Initialize().Bold().Append(BA.ObjectToCharSequence("Last update: ")).Pop().Color(anywheresoftware.b4a.keywords.Common.Colors.Red).Append(BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.DateTime.Date(_lngticks))).PopAll().getObject()));
 }else {
 //BA.debugLineNum = 284;BA.debugLine="lblAirQualityLastUpdate.Text = cs.Initialize";
mostCurrent._lblairqualitylastupdate.setText(BA.ObjectToCharSequence(_cs.Initialize().Bold().Append(BA.ObjectToCharSequence("Last update: ")).Pop().Append(BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.DateTime.Date(_lngticks))).PopAll().getObject()));
 };
 }else if((_a[(int) (2)]).equals("00:00:00")) { 
 //BA.debugLineNum = 287;BA.debugLine="lblAirQualityLastUpdate.Text = cs.Initialize.";
mostCurrent._lblairqualitylastupdate.setText(BA.ObjectToCharSequence(_cs.Initialize().Bold().Append(BA.ObjectToCharSequence("Last update: ")).Pop().Color(anywheresoftware.b4a.keywords.Common.Colors.Red).Append(BA.ObjectToCharSequence(mostCurrent._lblairqualitylastupdate.getText().replace("Last update: ",""))).PopAll().getObject()));
 };
 };
 //BA.debugLineNum = 290;BA.debugLine="CheckAirQualitySetting";
_checkairqualitysetting();
 };
 } 
       catch (Exception e62) {
			processBA.setLastException(e62); //BA.debugLineNum = 293;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)));
 };
...
anywheresoftware.b4a.objects.drawable.BitmapDrawable _bd = null;
 //BA.debugLineNum = 452;BA.debugLine="Sub ShowAboutMenu";
 //BA.debugLineNum = 453;BA.debugLine="Try";
try { //BA.debugLineNum = 454;BA.debugLine="Dim bd As BitmapDrawable";
_bd = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 455;BA.debugLine="bd.Initialize(LoadBitmapResize(File.DirAssets, \"";
_bd.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"cloyd.png",anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (32)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (32)),anywheresoftware.b4a.keywords.Common.True).getObject()));
 //BA.debugLineNum = 456;BA.debugLine="Msgbox2(\"Smart Home Monitor v\" & GetVersionCode";
anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence("Smart Home Monitor v"+_getversioncode()+anywheresoftware.b4a.keywords.Common.CRLF+anywheresoftware.b4a.keywords.Common.CRLF+"Developed by Cloyd Nino Catanaoan"+anywheresoftware.b4a.keywords.Common.CRLF+"April 29, 2018"),BA.ObjectToCharSequence("About"),"OK","","",_bd.getBitmap(),mostCurrent.activityBA);
			...
			processBA.setLastException(e6); //BA.debugLineNum = 458;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)));
 };
...
public static String  _tabstrip1_pageselected(int _position) throws Exception{
 //BA.debugLineNum = 503;BA.debugLine="Sub TabStrip1_PageSelected (Position As Int)";
 //BA.debugLineNum = 504;BA.debugLine="Try";
try { //BA.debugLineNum = 505;BA.debugLine="If Position = 2 Then";
if (_position==2) { 
 //BA.debugLineNum = 506;BA.debugLine="DSBottomNavigationView1.CheckedItem=1";
mostCurrent._dsbottomnavigationview1.setCheckedItem((int) (1));
 }else {
 //BA.debugLineNum = 508;BA.debugLine="WebView1.StopLoading";
mostCurrent._webview1.StopLoading();
 //BA.debugLineNum = 509;BA.debugLine="WebView1.RemoveView";
mostCurrent._webview1.RemoveView();
 };
 //BA.debugLineNum = 511;BA.debugLine="If Position = 0 Then";
if (_position==0) { 
 //BA.debugLineNum = 512;BA.debugLine="If MQTT.IsInitialized And MQTT.Connected  Then";
if (_mqtt.IsInitialized() && _mqtt.getConnected()) { 
 //BA.debugLineNum = 513;BA.debugLine="MQTT.Publish(\"TempHumid\", bc.StringToBytes(\"Re";
_mqtt.Publish("TempHumid",_bc.StringToBytes("Read weather","utf8"));
 };
 //BA.debugLineNum = 515;BA.debugLine="CheckTempHumiditySetting";
_checktemphumiditysetting();
 };
 //BA.debugLineNum = 517;BA.debugLine="If Position = 1 Then";
if (_position==1) { 
 //BA.debugLineNum = 518;BA.debugLine="If MQTT.IsInitialized And MQTT.Connected  Then";
if (_mqtt.IsInitialized() && _mqtt.getConnected()) { 
 //BA.debugLineNum = 519;BA.debugLine="MQTT.Publish(\"MQ7\", bc.StringToBytes(\"Read vol";
_mqtt.Publish("MQ7",_bc.StringToBytes("Read voltage","utf8"));
 };
 //BA.debugLineNum = 521;BA.debugLine="CheckAirQualitySetting";
_checkairqualitysetting();
 };
 } 
       catch (Exception e21) {
			processBA.setLastException(e21); //BA.debugLineNum = 524;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)));
 };
...
String _s = "";
float _f = 0f;
 //BA.debugLineNum = 565;BA.debugLine="Sub WebView1_PageFinished (Url As String)";
 //BA.debugLineNum = 566;BA.debugLine="Try";
try { //BA.debugLineNum = 567;BA.debugLine="Dim Obj1 As Reflector";
_obj1 = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 568;BA.debugLine="Dim s As String 'ignore";
_s = "";
 //BA.debugLineNum = 569;BA.debugLine="Dim f As Float 'ignore";
_f = 0f;
 //BA.debugLineNum = 571;BA.debugLine="Obj1.Target = WebView1";
_obj1.Target = (Object)(mostCurrent._webview1.getObject());
 //BA.debugLineNum = 572;BA.debugLine="s = Obj1.TypeName";
_s = _obj1.getTypeName();
 //BA.debugLineNum = 573;BA.debugLine="f = Obj1.RunMethod(\"getScale\")";
_f = (float)(BA.ObjectToNumber(_obj1.RunMethod("getScale")));
 //BA.debugLineNum = 575;BA.debugLine="Obj1.Target = WebView1";
_obj1.Target = (Object)(mostCurrent._webview1.getObject());
 //BA.debugLineNum = 576;BA.debugLine="Obj1.RunMethod2(\"setInitialScale\", \"230\", \"java.";
_obj1.RunMethod2("setInitialScale","230","java.lang.int");
 } 
       catch (Exception e11) {
			processBA.setLastException(e11); //BA.debugLineNum = 578;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)));
 };
...
public static String[]  _webview1_userandpasswordrequired(String _host,String _realm) throws Exception{
 //BA.debugLineNum = 677;BA.debugLine="Sub WebView1_UserAndPasswordRequired (Host As Stri";
 //BA.debugLineNum = 678;BA.debugLine="Return Array As String(\"admin\", \"960124\")";
