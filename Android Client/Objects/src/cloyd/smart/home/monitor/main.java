...
if (_position==0) { 
 //BA.debugLineNum = 462;BA.debugLine="If MQTT.IsInitialized And MQTT.Connected  Then";
if (_mqtt.IsInitialized() && _mqtt.getConnected()) { 
 //BA.debugLineNum = 463;BA.debugLine="MQTT.Publish(\"TempHumid\", bc.StringToBytes(\"Rea";
_mqtt.Publish("TempHumid",_bc.StringToBytes("Read weather","utf8"));
 };
 };
 //BA.debugLineNum = 466;BA.debugLine="If Position = 1 Then";
if (_position==1) { 
 //BA.debugLineNum = 467;BA.debugLine="If MQTT.IsInitialized And MQTT.Connected  Then";
if (_mqtt.IsInitialized() && _mqtt.getConnected()) { 
 //BA.debugLineNum = 468;BA.debugLine="MQTT.Publish(\"MQ7\", bc.StringToBytes(\"Read volt";
