...
public String  _class_globals() throws Exception{
 ...
 //BA.debugLineNum = 3;BA.debugLine="Private Const METADATA_KEY_ALBUM            As";
_metadata_key_album = (int) (1);
 //BA.debugLineNum = 4;BA.debugLine="Private Const METADATA_KEY_ALBUMARTIST      As";
_metadata_key_albumartist = (int) (13);
 //BA.debugLineNum = 5;BA.debugLine="Private Const METADATA_KEY_ARTIST           As";
_metadata_key_artist = (int) (2);
 //BA.debugLineNum = 6;BA.debugLine="Private Const METADATA_KEY_AUTHOR           As";
_metadata_key_author = (int) (3);
 //BA.debugLineNum = 7;BA.debugLine="Private Const METADATA_KEY_BITRATE          As";
_metadata_key_bitrate = (int) (20);
 //BA.debugLineNum = 8;BA.debugLine="Private Const METADATA_KEY_CD_TRACK_NUMBER  As";
_metadata_key_cd_track_number = (int) (0);
 //BA.debugLineNum = 9;BA.debugLine="Private Const METADATA_KEY_COMPILATION      As";
_metadata_key_compilation = (int) (15);
 //BA.debugLineNum = 10;BA.debugLine="Private Const METADATA_KEY_COMPOSER         As";
_metadata_key_composer = (int) (4);
 //BA.debugLineNum = 11;BA.debugLine="Private Const METADATA_KEY_DATE             As";
_metadata_key_date = (int) (5);
 //BA.debugLineNum = 12;BA.debugLine="Private Const METADATA_KEY_DISC_NUMBER      As";
_metadata_key_disc_number = (int) (14);
 //BA.debugLineNum = 13;BA.debugLine="Private Const METADATA_KEY_DURATION         As";
_metadata_key_duration = (int) (9);
 //BA.debugLineNum = 14;BA.debugLine="Private Const METADATA_KEY_GENRE            As";
_metadata_key_genre = (int) (6);
 //BA.debugLineNum = 15;BA.debugLine="Private Const METADATA_KEY_HAS_AUDIO        As";
_metadata_key_has_audio = (int) (16);
 //BA.debugLineNum = 16;BA.debugLine="Private Const METADATA_KEY_HAS_VIDEO        As";
_metadata_key_has_video = (int) (17);
 //BA.debugLineNum = 17;BA.debugLine="Private Const METADATA_KEY_LOCATION         As";
_metadata_key_location = (int) (23);
 //BA.debugLineNum = 18;BA.debugLine="Private Const METADATA_KEY_MIMETYPE         As";
_metadata_key_mimetype = (int) (12);
 //BA.debugLineNum = 19;BA.debugLine="Private Const METADATA_KEY_NUM_TRACKS       As";
_metadata_key_num_tracks = (int) (10);
 //BA.debugLineNum = 20;BA.debugLine="Private Const METADATA_KEY_TITLE            As";
_metadata_key_title = (int) (7);
 //BA.debugLineNum = 21;BA.debugLine="Private Const METADATA_KEY_VIDEO_HEIGHT     As";
_metadata_key_video_height = (int) (19);
 //BA.debugLineNum = 22;BA.debugLine="Private Const METADATA_KEY_VIDEO_ROTATION   As";
_metadata_key_video_rotation = (int) (24);
 //BA.debugLineNum = 23;BA.debugLine="Private Const METADATA_KEY_VIDEO_WIDTH      As";
_metadata_key_video_width = (int) (18);
 //BA.debugLineNum = 24;BA.debugLine="Private Const METADATA_KEY_WRITER           As";
_metadata_key_writer = (int) (11);
 //BA.debugLineNum = 25;BA.debugLine="Private Const METADATA_KEY_YEAR             As";
_metadata_key_year = (int) (8);
