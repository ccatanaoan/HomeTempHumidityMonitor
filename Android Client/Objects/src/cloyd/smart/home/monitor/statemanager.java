...
anywheresoftware.b4a.keywords.Common.LogImpl("75308436","Error loading state.",0);
 //BA.debugLineNum = 230;BA.debugLine="Log(LastException.Message)";
anywheresoftware.b4a.keywords.Common.LogImpl("75308437",anywheresoftware.b4a.keywords.Common.LastException(_ba).getMessage(),0);
