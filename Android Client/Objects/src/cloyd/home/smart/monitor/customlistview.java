...
public class customlistview extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "cloyd.home.smart.monitor.customlistview");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", cloyd.home.smart.monitor.customlistview.class).invoke(this, new Object[] {null});
        else
...
int _scrollbar = 0;
cloyd.home.smart.monitor.customlistview._clvitem _it = null;
...
_it = (cloyd.home.smart.monitor.customlistview._clvitem)(group6.Get(index6));
...
_it = (cloyd.home.smart.monitor.customlistview._clvitem)(group12.Get(index12));
...
int _position = 0;
int _stepsize = 0;
cloyd.home.smart.monitor.customlistview._clvitem _currentitem = null;
int _nextoffset = 0;
int _prevoffset = 0;
...
_currentitem = (cloyd.home.smart.monitor.customlistview._clvitem)(_items.Get(_position));
...
public cloyd.home.smart.monitor.customlistview._clvitem  _getitem(int _index) throws Exception{
...
if (true) return (cloyd.home.smart.monitor.customlistview._clvitem)(_items.Get(_index));
...
cloyd.home.smart.monitor.customlistview._clvitem _newitem = null;
int _offset = 0;
cloyd.home.smart.monitor.customlistview._clvitem _previtem = null;
int _i = 0;
cloyd.home.smart.monitor.customlistview._clvitem _it = null;
int _newoffset = 0;
...
_newitem = new cloyd.home.smart.monitor.customlistview._clvitem();
...
_previtem = (cloyd.home.smart.monitor.customlistview._clvitem)(_items.Get((int) (_index-1)));
...
_it = (cloyd.home.smart.monitor.customlistview._clvitem)(_items.Get(_i));
...
anywheresoftware.b4a.objects.B4XViewWrapper _lbl = null;
cloyd.home.smart.monitor.customlistview._clvitem _item = null;
...
public ResumableSub_PanelClickHandler(cloyd.home.smart.monitor.customlistview parent,anywheresoftware.b4a.objects.B4XViewWrapper _senderpanel) {
this.parent = parent;
this._senderpanel = _senderpanel;
}
cloyd.home.smart.monitor.customlistview parent;
...
cloyd.home.smart.monitor.customlistview._clvitem _removeitem = null;
anywheresoftware.b4a.objects.B4XViewWrapper _p = null;
int _i = 0;
cloyd.home.smart.monitor.customlistview._clvitem _item = null;
int _newoffset = 0;
...
_removeitem = (cloyd.home.smart.monitor.customlistview._clvitem)(_items.Get(_index));
...
_item = (cloyd.home.smart.monitor.customlistview._clvitem)(_items.Get(_i));
...
public String  _setitemoffset(cloyd.home.smart.monitor.customlistview._clvitem _item,float _offset) throws Exception{
