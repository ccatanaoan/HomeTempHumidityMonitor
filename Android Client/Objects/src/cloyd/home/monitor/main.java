...
_mqtt_connect();
			...
			processBA.setLastException(e6); //BA.debugLineNum = 164;BA.debugLine="AddEvent(\"btnRefresh_Click: \" & LastException)";
...
_bd.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"0.jpg",anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (32)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (32)),anywheresoftware.b4a.keywords.Common.True).getObject()));
 //BA.debugLineNum = 174;BA.debugLine="result = Msgbox2(\"Restart the controller?\", \"Clo";
...
_mqtt_connect();
			...
			processBA.setLastException(e12); //BA.debugLineNum = 182;BA.debugLine="AddEvent(\"btnRestart_Click: \" & LastException)";
...
_addevent("Connected to MQTT broker");
 //BA.debugLineNum = 95;BA.debugLine="MQTT.Subscribe(\"Cloyd\", 0)";
...
_bd.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"0.jpg",anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (32)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (32)),anywheresoftware.b4a.keywords.Common.True).getObject()));
 //BA.debugLineNum = 201;BA.debugLine="Msgbox2(\"Cloyd Home Monitor v\" & GetVersionCode";
...
_btnrefresh_click();
			...
			processBA.setLastException(e10); //BA.debugLineNum = 153;BA.debugLine="AddEvent(\"tglRelaySwitch_CheckedChange: \" & Last";
