...
B4R::B4RString* be_ann74_11e1[1];
B4R::Array be_ann74_11e2;
...
_s = B4R::__c->JoinStrings(be_ann74_11e2.create(be_ann74_11e1,1,100,B4R::B4RString::fromNumber((Long)(b4r_main::_readvoltage))));
...
UInt _rawvoltage = 0;
B4R::B4RString* _s = B4R::B4RString::EMPTY;
B4R::B4RString* be_ann179_11e1[1];
...
B4R::Common::LogHelper(2,102,F("MQ-7 PPM: "),4,_rawvoltage);
 //BA.debugLineNum = 267;BA.debugLine="readVoltage = rawvoltage";
b4r_main::_readvoltage = _rawvoltage;
 //BA.debugLineNum = 269;BA.debugLine="Dim s As String";
_s = B4R::B4RString::EMPTY;
 //BA.debugLineNum = 270;BA.debugLine="s = JoinStrings(Array As String(rawvoltage))";
_s = B4R::__c->JoinStrings(be_ann179_11e2.create(be_ann179_11e1,1,100,B4R::B4RString::fromNumber((Long)(_rawvoltage))));
 //BA.debugLineNum = 271;BA.debugLine="Log(\"Sending ppm via MQTT: \",s)";
B4R::Common::LogHelper(2,102,F("Sending ppm via MQTT: "),101,_s->data);
 //BA.debugLineNum = 272;BA.debugLine="If WiFi.IsConnected Then";
if (b4r_main::_wifi->getIsConnected()) { 
...
B4R::B4RString* _s = B4R::B4RString::EMPTY;
B4R::B4RString be_ann149_12;
B4R::B4RString be_ann149_16;
B4R::B4RString be_ann149_20;
B4R::B4RString be_ann149_24;
B4R::B4RString be_ann149_28;
B4R::B4RString be_ann149_32;
B4R::B4RString* be_ann149_35e1[13];
B4R::Array be_ann149_35e2;
B4R::B4RString be_ann151_4;
...
;
 //BA.debugLineNum = 186;BA.debugLine="Dim localperception As String";
_localperception = B4R::B4RString::EMPTY;
 //BA.debugLineNum = 187;BA.debugLine="Select Case DHT22Perception";
switch (b4r_main::_dht22perception) {
case 0: {
 //BA.debugLineNum = 189;BA.debugLine="localperception = \"Feels like the western US, a";
_localperception = be_ann107_2.wrap("Feels like the western US, a bit dry to some");
 break; }
case 1: {
 //BA.debugLineNum = 191;BA.debugLine="localperception = \"Very comfortable\"";
_localperception = be_ann109_2.wrap("Very comfortable");
 break; }
case 2: {
 //BA.debugLineNum = 193;BA.debugLine="localperception = \"Comfortable\"";
_localperception = be_ann111_2.wrap("Comfortable");
 break; }
case 3: {
 //BA.debugLineNum = 195;BA.debugLine="localperception = \"OK but everyone perceives th";
_localperception = be_ann113_2.wrap("OK but everyone perceives the humidity at upper limit");
 break; }
case 4: {
 //BA.debugLineNum = 197;BA.debugLine="localperception = \"Somewhat uncomfortable for m";
_localperception = be_ann115_2.wrap("Somewhat uncomfortable for most people at upper limit");
 break; }
case 5: {
 //BA.debugLineNum = 199;BA.debugLine="localperception = \"Very humid, quite uncomforta";
_localperception = be_ann117_2.wrap("Very humid, quite uncomfortable");
 break; }
case 6: {
 //BA.debugLineNum = 201;BA.debugLine="localperception = \"Extremely uncomfortable, opp";
_localperception = be_ann119_2.wrap("Extremely uncomfortable, oppressive");
 break; }
case 7: {
 //BA.debugLineNum = 203;BA.debugLine="localperception = \"Severely high, even deadly f";
_localperception = be_ann121_2.wrap("Severely high, even deadly for asthma related illnesses");
 break; }
}
;
 //BA.debugLineNum = 206;BA.debugLine="Dim localcomfortstatus As String";
_localcomfortstatus = B4R::B4RString::EMPTY;
 //BA.debugLineNum = 207;BA.debugLine="Select Case DHT22ComfortStatus";
switch (b4r_main::_dht22comfortstatus) {
case 0: {
 //BA.debugLineNum = 209;BA.debugLine="localcomfortstatus = \"OK\"";
_localcomfortstatus = be_ann126_2.wrap("OK");
 break; }
case 1: {
 //BA.debugLineNum = 211;BA.debugLine="localcomfortstatus = \"Too hot\"";
_localcomfortstatus = be_ann128_2.wrap("Too hot");
 break; }
case 2: {
 //BA.debugLineNum = 213;BA.debugLine="localcomfortstatus = \"Too cold\"";
_localcomfortstatus = be_ann130_2.wrap("Too cold");
 break; }
case 4: {
 //BA.debugLineNum = 215;BA.debugLine="localcomfortstatus = \"Too dry\"";
_localcomfortstatus = be_ann132_2.wrap("Too dry");
 break; }
case 5: {
 //BA.debugLineNum = 217;BA.debugLine="localcomfortstatus = \"Hot and dry\"";
_localcomfortstatus = be_ann134_2.wrap("Hot and dry");
 break; }
case 6: {
 //BA.debugLineNum = 219;BA.debugLine="localcomfortstatus = \"Cold and dry\"";
_localcomfortstatus = be_ann136_2.wrap("Cold and dry");
 break; }
case 8: {
 //BA.debugLineNum = 221;BA.debugLine="localcomfortstatus = \"Too humid\"";
_localcomfortstatus = be_ann138_2.wrap("Too humid");
 break; }
case 9: {
 //BA.debugLineNum = 223;BA.debugLine="localcomfortstatus = \"Hot and humid\"";
_localcomfortstatus = be_ann140_2.wrap("Hot and humid");
 break; }
case 10: {
 //BA.debugLineNum = 225;BA.debugLine="localcomfortstatus = \"Cold and humid\"";
_localcomfortstatus = be_ann142_2.wrap("Cold and humid");
 break; }
default: {
 //BA.debugLineNum = 227;BA.debugLine="localcomfortstatus = \"Unknown\"";
_localcomfortstatus = be_ann144_2.wrap("Unknown");
 break; }
}
;
 //BA.debugLineNum = 230;BA.debugLine="Log(\"State: \", localstate, \" Temp: \", DHT22Temp,";
B4R::Common::LogHelper(15,102,F("State: "),101,_localstate->data,102,F(" Temp: "),7,(double)(b4r_main::_dht22temp),102,F(" ºF Humidity: "),7,(double)(b4r_main::_dht22hum),102,F(" % Perception: "),101,_localperception->data,102,F(" Comfort Status: "),101,_localcomfortstatus->data,102,F(" HeatIndex: "),7,(double)(b4r_main::_dht22heatindex),102,F(" ºF Dew Point: "),7,(double)(b4r_main::_dht22dewpoint),102,F(" ºF"));
 //BA.debugLineNum = 231;BA.debugLine="If WiFi.IsConnected Then";
if (b4r_main::_wifi->getIsConnected()) { 
 //BA.debugLineNum = 232;BA.debugLine="Dim s As String";
_s = B4R::B4RString::EMPTY;
 //BA.debugLineNum = 233;BA.debugLine="s = JoinStrings(Array As String(localstate,\"|\",D";
_s = B4R::__c->JoinStrings(be_ann149_35e2.create(be_ann149_35e1,13,100,_localstate,be_ann149_12.wrap("|"),B4R::B4RString::fromNumber((Double)(b4r_main::_dht22temp)),be_ann149_16.wrap("|"),B4R::B4RString::fromNumber((Double)(b4r_main::_dht22hum)),be_ann149_20.wrap("|"),B4R::B4RString::fromNumber((Long)(b4r_main::_dht22perception)),be_ann149_24.wrap("|"),B4R::B4RString::fromNumber((Long)(b4r_main::_dht22comfortstatus)),be_ann149_28.wrap("|"),B4R::B4RString::fromNumber((Double)(b4r_main::_dht22heatindex)),be_ann149_32.wrap("|"),B4R::B4RString::fromNumber((Double)(b4r_main::_dht22dewpoint))));
 //BA.debugLineNum = 234;BA.debugLine="Log(\"Sending TempHumid to MQTT: \",s)";
B4R::Common::LogHelper(2,102,F("Sending TempHumid to MQTT: "),101,_s->data);
 //BA.debugLineNum = 235;BA.debugLine="MQTT.Publish(\"TempHumid\",s)";
b4r_main::_mqtt->Publish(be_ann151_4.wrap("TempHumid"),(_s)->GetBytes());
 };
 //BA.debugLineNum = 238;BA.debugLine="CallSubPlus(\"ReadWeather\",5000,0)";
