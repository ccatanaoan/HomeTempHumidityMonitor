...
B4R::B4RString be_ann139_3;
B4R::B4RString be_ann140_10;
B4R::B4RString be_ann140_14;
B4R::B4RString be_ann140_16;
B4R::B4RString be_ann140_20;
B4R::B4RString be_ann140_24;
B4R::B4RString be_ann140_26;
B4R::B4RString be_ann140_32;
B4R::B4RString be_ann140_34;
B4R::B4RString be_ann140_40;
B4R::B4RString be_ann140_42;
B4R::B4RString be_ann140_46;
B4R::B4RString* be_ann140_47e1[16];
B4R::Array be_ann140_47e2;
B4R::ByteConverter be_ann141_3;
B4R::ByteConverter* _bc = NULL;
B4R::B4RString be_ann144_10;
B4R::B4RString be_ann144_14;
B4R::B4RString be_ann144_16;
B4R::B4RString be_ann144_20;
B4R::B4RString be_ann144_24;
B4R::B4RString be_ann144_26;
B4R::B4RString* be_ann144_29e1[9];
B4R::Array be_ann144_29e2;
B4R::B4RString be_ann147_10;
B4R::B4RString be_ann147_12;
B4R::B4RString* be_ann147_13e1[2];
B4R::Array be_ann147_13e2;
B4R::B4RString be_ann149_4;
...
_s = B4R::B4RString::EMPTY;
 //BA.debugLineNum = 185;BA.debugLine="If localstate = \"OK\" Then";
if ((_localstate)->equals(be_ann139_3.wrap("OK"))) { 
 //BA.debugLineNum = 187;BA.debugLine="s = JoinStrings(Array As String(\"Humidity = \",";
_s = B4R::__c->JoinStrings(be_ann140_47e2.create(be_ann140_47e1,16,100,be_ann140_10.wrap("Humidity = "),B4R::B4RString::fromNumber((Double)(b4r_main::_dht11hum)),be_ann140_14.wrap(" %"),be_ann140_16.wrap(" Temperature = "),B4R::B4RString::fromNumber((Double)(b4r_main::_dht11temp)),be_ann140_20.wrap(" ºF"),be_ann140_24.wrap(Common_CRLF),be_ann140_26.wrap(" Perception = "),_localperception,be_ann140_32.wrap(Common_CRLF),be_ann140_34.wrap(" Comfort Status = "),_localcomfortstatus,be_ann140_40.wrap(Common_CRLF),be_ann140_42.wrap(" HeatIndex: "),B4R::B4RString::fromNumber((Double)(b4r_main::_dht11heatindex)),be_ann140_46.wrap(" ºF")));
 //BA.debugLineNum = 188;BA.debugLine="Dim bc As ByteConverter";
_bc = &be_ann141_3;
 //BA.debugLineNum = 189;BA.debugLine="Log(\"Payload length: \", bc.StringToBytes(s).len";
B4R::Common::LogHelper(2,102,F("Payload length: "),3,_bc->StringToBytes(_s)->length);
 //BA.debugLineNum = 190;BA.debugLine="If bc.StringToBytes(s).length >= 150 Then";
if (_bc->StringToBytes(_s)->length>=150) { 
 //BA.debugLineNum = 191;BA.debugLine="s = JoinStrings(Array As String(\"Humidity = \",";
_s = B4R::__c->JoinStrings(be_ann144_29e2.create(be_ann144_29e1,9,100,be_ann144_10.wrap("Humidity = "),B4R::B4RString::fromNumber((Double)(b4r_main::_dht11hum)),be_ann144_14.wrap(" %"),be_ann144_16.wrap(" Temperature = "),B4R::B4RString::fromNumber((Double)(b4r_main::_dht11temp)),be_ann144_20.wrap(" ºF"),be_ann144_24.wrap(Common_CRLF),be_ann144_26.wrap(" Perception = "),_localperception));
 };
 }else {
 //BA.debugLineNum = 194;BA.debugLine="s = JoinStrings(Array As String(\"Humidity = 0 %";
_s = B4R::__c->JoinStrings(be_ann147_13e2.create(be_ann147_13e1,2,100,be_ann147_10.wrap("Humidity = 0 %"),be_ann147_12.wrap("  Temperature = 0 ºF")));
 };
 //BA.debugLineNum = 196;BA.debugLine="MQTT.Publish(\"Cloyd\",s)";
b4r_main::_mqtt->Publish(be_ann149_4.wrap("Cloyd"),(_s)->GetBytes());
 };
