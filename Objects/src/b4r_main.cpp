...
b4r_main::_esp = &be_gann14_3;
 //BA.debugLineNum = 25;BA.debugLine="Private WiFiSSID As String = \"Rise Above This Hom";
b4r_main::_wifissid = be_gann15_5.wrap("Rise Above This Home");
 //BA.debugLineNum = 26;BA.debugLine="Private WiFiPassword As String = \"SteelReserve\"";
b4r_main::_wifipassword = be_gann16_5.wrap("SteelReserve");
...
b4r_main::_dht11sensor->Read11(b4r_main::_dht11pin->PinNumber);
 //BA.debugLineNum = 73;BA.debugLine="humidity = DHT11sensor.GetHumidity + 12";
b4r_main::_humidity = b4r_main::_dht11sensor->GetHumidity()+12;
 //BA.debugLineNum = 74;BA.debugLine="temperature = DHT11sensor.GetTemperature * 9 / 5";
