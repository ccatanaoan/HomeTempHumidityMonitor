# 1 "C:\\Users\\Cloyd\\Desktop\\HomeTempHumidityMonitor\\Library\\ArduCAM-mini-ESP8266-12E-Camera-Server-master\\ArduCAM-mini-ESP8266-12E-Camera-Server-master\\ArduCam_ESP8266_FileCapture\\ArduCam_ESP8266_FileCapture.ino"
# 1 "C:\\Users\\Cloyd\\Desktop\\HomeTempHumidityMonitor\\Library\\ArduCAM-mini-ESP8266-12E-Camera-Server-master\\ArduCAM-mini-ESP8266-12E-Camera-Server-master\\ArduCam_ESP8266_FileCapture\\ArduCam_ESP8266_FileCapture.ino"
...
# 37 "C:\\Users\\Cloyd\\Desktop\\HomeTempHumidityMonitor\\Library\\ArduCAM-mini-ESP8266-12E-Camera-Server-master\\ArduCAM-mini-ESP8266-12E-Camera-Server-master\\ArduCam_ESP8266_FileCapture\\ArduCam_ESP8266_FileCapture.ino" 2
# 38 "C:\\Users\\Cloyd\\Desktop\\HomeTempHumidityMonitor\\Library\\ArduCAM-mini-ESP8266-12E-Camera-Server-master\\ArduCAM-mini-ESP8266-12E-Camera-Server-master\\ArduCam_ESP8266_FileCapture\\ArduCam_ESP8266_FileCapture.ino" 2
# 39 "C:\\Users\\Cloyd\\Desktop\\HomeTempHumidityMonitor\\Library\\ArduCAM-mini-ESP8266-12E-Camera-Server-master\\ArduCAM-mini-ESP8266-12E-Camera-Server-master\\ArduCam_ESP8266_FileCapture\\ArduCam_ESP8266_FileCapture.ino" 2
# 40 "C:\\Users\\Cloyd\\Desktop\\HomeTempHumidityMonitor\\Library\\ArduCAM-mini-ESP8266-12E-Camera-Server-master\\ArduCAM-mini-ESP8266-12E-Camera-Server-master\\ArduCam_ESP8266_FileCapture\\ArduCam_ESP8266_FileCapture.ino" 2
# 41 "C:\\Users\\Cloyd\\Desktop\\HomeTempHumidityMonitor\\Library\\ArduCAM-mini-ESP8266-12E-Camera-Server-master\\ArduCAM-mini-ESP8266-12E-Camera-Server-master\\ArduCam_ESP8266_FileCapture\\ArduCam_ESP8266_FileCapture.ino" 2
# 42 "C:\\Users\\Cloyd\\Desktop\\HomeTempHumidityMonitor\\Library\\ArduCAM-mini-ESP8266-12E-Camera-Server-master\\ArduCAM-mini-ESP8266-12E-Camera-Server-master\\ArduCam_ESP8266_FileCapture\\ArduCam_ESP8266_FileCapture.ino" 2
# 43 "C:\\Users\\Cloyd\\Desktop\\HomeTempHumidityMonitor\\Library\\ArduCAM-mini-ESP8266-12E-Camera-Server-master\\ArduCAM-mini-ESP8266-12E-Camera-Server-master\\ArduCam_ESP8266_FileCapture\\ArduCam_ESP8266_FileCapture.ino" 2
# 44 "C:\\Users\\Cloyd\\Desktop\\HomeTempHumidityMonitor\\Library\\ArduCAM-mini-ESP8266-12E-Camera-Server-master\\ArduCAM-mini-ESP8266-12E-Camera-Server-master\\ArduCam_ESP8266_FileCapture\\ArduCam_ESP8266_FileCapture.ino" 2
...
void myCAMSaveToSPIFFS() {
  ...
  while (!myCAM.get_bit(0x41 /*Trigger source*/ , 0x08));
...
void setCamResolution(int reso)
{
  ...
  {
    case 0:
      myCAM.OV2640_set_JPEG_size(0 /*160x120*/);
      resolution = 0;
      break;

    case 1:
      myCAM.OV2640_set_JPEG_size(1 /*176x144*/);
      resolution = 1;
      break;

    case 2:
      myCAM.OV2640_set_JPEG_size(2 /*320x240*/);
      resolution = 2;
      break;

    case 3:
      myCAM.OV2640_set_JPEG_size(3 /*352x288*/);
      resolution = 3;
      break;

    case 4:
      myCAM.OV2640_set_JPEG_size(4 /*640x480*/);
      resolution = 4;
      break;

    case 5:
      myCAM.OV2640_set_JPEG_size(5 /*800x600*/);
      resolution = 5;
      break;

    case 6:
      myCAM.OV2640_set_JPEG_size(6 /*1024x768*/);
      resolution = 6;
      break;

    case 7:
      myCAM.OV2640_set_JPEG_size(7 /*1280x1024*/);
      resolution = 7;
      break;

    case 8:
      myCAM.OV2640_set_JPEG_size(8 /*1600x1200*/);
      resolution = 8;
      break;
...
void setup() {
  ...
  myCAM.write_reg(0x00 /*TEST register*/, 0x55);
  temp = myCAM.read_reg(0x00 /*TEST register*/);
  if (temp != 0x55) {
