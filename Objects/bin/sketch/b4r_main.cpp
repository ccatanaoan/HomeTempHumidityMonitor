...
B4R::B4RString* _clientid = B4R::B4RString::EMPTY;
 //BA.debugLineNum = 83;BA.debugLine="Private Sub AppStart";
 //BA.debugLineNum = 84;BA.debugLine="Serial1.Initialize(115200)";
b4r_main::_serial1->Initialize((ULong) (115200));
 //BA.debugLineNum = 85;BA.debugLine="Delay(3000)";
Common_Delay((ULong) (3000));
 //BA.debugLineNum = 86;BA.debugLine="Log(\"AppStart\")";
B4R::Common::LogHelper(1,102,F("AppStart"));
 //BA.debugLineNum = 88;BA.debugLine="Dim bb() As Byte = \"LivingRoomTempHumid\"";
_bb = (be_ann31_8.wrap("LivingRoomTempHumid"))->GetBytes();
 //BA.debugLineNum = 89;BA.debugLine="RunNative(\"SetHostName\", bb)";
Common_RunNative(SetHostName,be_ann32_6.wrapPointer(_bb));
 //BA.debugLineNum = 90;BA.debugLine="RunNative(\"stopAP\", Null)";
Common_RunNative(stopAP,Common_Null);
 //BA.debugLineNum = 95;BA.debugLine="pin16.Initialize(16, pin16.MODE_OUTPUT)";
b4r_main::_pin16->Initialize((Byte) (16),Pin_MODE_OUTPUT);
 //BA.debugLineNum = 96;BA.debugLine="d6.Initialize(d1pins.D6, d6.MODE_OUTPUT)";
b4r_main::_d6->Initialize(b4r_main::_d1pins->D6,Pin_MODE_OUTPUT);
 //BA.debugLineNum = 99;BA.debugLine="ConnectToWifi";
_connecttowifi();
 //BA.debugLineNum = 102;BA.debugLine="Dim ClientId As String = Rnd(0, 999999999) 'creat";
_clientid = B4R::B4RString::fromNumber((Long)(Common_Rnd((Long) (0),(Long) (999999999))));
 //BA.debugLineNum = 103;BA.debugLine="MQTT.Initialize2(WiFiStr.stream, MQTTHostName, MQ";
...
_mqtt_connect((Byte) (0));
 //BA.debugLineNum = 107;BA.debugLine="DHT22pin.Initialize(d3pins.D3, DHT22pin.MODE_INPU";
...
const UInt cp = B4R::StackMemory::cp;
 ...
 //BA.debugLineNum = 155;BA.debugLine="If WiFi.IsConnected Then";
if (b4r_main::_wifi->getIsConnected()) { 
 //BA.debugLineNum = 156;BA.debugLine="Log(\"Connected to \",WiFiSSID,\" network, Local IP";
B4R::Common::LogHelper(4,102,F("Connected to "),101,b4r_main::_wifissid->data,102,F(" network, Local IP "),101,b4r_main::_wifi->getLocalIp()->data);
 ...
 //BA.debugLineNum = 158;BA.debugLine="pin16.DigitalWrite(True)";
...
B4R::Common::LogHelper(1,102,F("Connecting to WiFi"));
 //BA.debugLineNum = 160;BA.debugLine="If WiFi.Connect2(WiFiSSID, WiFiPassword) = False";
if (b4r_main::_wifi->Connect2(b4r_main::_wifissid,b4r_main::_wifipassword)==Common_False) { 
 //BA.debugLineNum = 161;BA.debugLine="ConnectToWifi";
_connecttowifi();
 };
 };
...
B4R::B4RString be_ann55_4;
 //BA.debugLineNum = 110;BA.debugLine="Sub MQTT_Connect(Unused As Byte)";
 //BA.debugLineNum = 111;BA.debugLine="If WiFi.IsConnected = False Then";
if (b4r_main::_wifi->getIsConnected()==Common_False) { 
 //BA.debugLineNum = 112;BA.debugLine="ConnectToWifi";
_connecttowifi();
 };
 //BA.debugLineNum = 115;BA.debugLine="If MQTT.Connect = False Then";
if (b4r_main::_mqtt->Connect()==Common_False) { 
 //BA.debugLineNum = 116;BA.debugLine="pin16.DigitalWrite(True)";
b4r_main::_pin16->DigitalWrite(Common_True);
 //BA.debugLineNum = 117;BA.debugLine="Log(\"Not connected to broker\")";
B4R::Common::LogHelper(1,102,F("Not connected to broker"));
 //BA.debugLineNum = 118;BA.debugLine="MQTT.Connect";
b4r_main::_mqtt->Connect();
 //BA.debugLineNum = 119;BA.debugLine="CallSubPlus(\"MQTT_Connect\", 1000, 0)";
...
b4r_main::_pin16->DigitalWrite(Common_False);
 //BA.debugLineNum = 122;BA.debugLine="Log(\"Connected to broker\")";
B4R::Common::LogHelper(1,102,F("Connected to broker"));
 //BA.debugLineNum = 123;BA.debugLine="MQTT.Subscribe(\"TempHumid\", 0)";
b4r_main::_mqtt->Subscribe(be_ann54_4.wrap("TempHumid"),(Byte) (0));
 //BA.debugLineNum = 124;BA.debugLine="MQTT.Subscribe(\"HumidityAddValue\", 0)";
b4r_main::_mqtt->Subscribe(be_ann55_4.wrap("HumidityAddValue"),(Byte) (0));
 //BA.debugLineNum = 125;BA.debugLine="ReadSensor";
_readsensor();
 };
...
B4R::B4RString be_ann68_3;
 ...
 //BA.debugLineNum = 130;BA.debugLine="Log(\"Message arrived. Topic=\", Topic, \" Payload=\"";
...
b4r_main::_esp->Restart();
 ...
 //BA.debugLineNum = 137;BA.debugLine="ReadWeather(1)";
_readweather((Byte) (1));
 };
 }else if((_topic)->equals(be_ann68_3.wrap("HumidityAddValue"))) { 
 //BA.debugLineNum = 140;BA.debugLine="DHT22HumidityAddValue = bc.StringFromBytes(Paylo";
b4r_main::_dht22humidityaddvalue = (Double)(atof(b4r_main::_bc->StringFromBytes(_payload)->data));
 //BA.debugLineNum = 141;BA.debugLine="If IsNumber(DHT22HumidityAddValue) = False Then";
if (B4R::__c->IsNumber(B4R::B4RString::fromNumber((Double)(b4r_main::_dht22humidityaddvalue)))==Common_False) { 
 //BA.debugLineNum = 142;BA.debugLine="DHT22HumidityAddValue = 0";
...
b4r_main::_mqtt = &be_gann7_3;
 //BA.debugLineNum = 63;BA.debugLine="Private MQTTHostName As String = \"test.mosquitto.";
b4r_main::_mqtthostname = be_gann8_5.wrap("test.mosquitto.org");
 //BA.debugLineNum = 64;BA.debugLine="Private MQTTPort As Int = 1883";
b4r_main::_mqttport = 1883;
 //BA.debugLineNum = 65;BA.debugLine="Private ESP As ESP8266";
b4r_main::_esp = &be_gann10_3;
 //BA.debugLineNum = 66;BA.debugLine="Private WiFiSSID As String = \"InternetOfThings\"";
b4r_main::_wifissid = be_gann11_5.wrap("InternetOfThings");
 //BA.debugLineNum = 67;BA.debugLine="Private WiFiPassword As String = \"SteelReserve\"";
b4r_main::_wifipassword = be_gann12_5.wrap("SteelReserve");
 //BA.debugLineNum = 68;BA.debugLine="Public DHT22pin As Pin                    ' ESP82";
b4r_main::_dht22pin = &be_gann13_3;
 //BA.debugLineNum = 69;BA.debugLine="Private d3pins As D1Pins";
b4r_main::_d3pins = &be_gann14_3;
 //BA.debugLineNum = 70;BA.debugLine="Public DHT22Temp As Double";
b4r_main::_dht22temp = 0;
 //BA.debugLineNum = 71;BA.debugLine="Public DHT22Hum As Double";
b4r_main::_dht22hum = 0;
 //BA.debugLineNum = 72;BA.debugLine="Public DHT22State As Int";
b4r_main::_dht22state = 0;
 //BA.debugLineNum = 73;BA.debugLine="Public DHT22HeatIndex As Double";
b4r_main::_dht22heatindex = 0;
 //BA.debugLineNum = 74;BA.debugLine="Public DHT22DewPoint As Double";
b4r_main::_dht22dewpoint = 0;
 //BA.debugLineNum = 75;BA.debugLine="Public DHT22Perception As Int";
b4r_main::_dht22perception = 0;
 //BA.debugLineNum = 76;BA.debugLine="Public DHT22ComfortStatus As Int";
b4r_main::_dht22comfortstatus = 0;
 //BA.debugLineNum = 77;BA.debugLine="Private bc As ByteConverter";
b4r_main::_bc = &be_gann22_3;
 //BA.debugLineNum = 78;BA.debugLine="Public DHT22HumidityAddValue As Double";
b4r_main::_dht22humidityaddvalue = 0;
 //BA.debugLineNum = 79;BA.debugLine="Public timelib As ESPTimetools";
b4r_main::_timelib = &be_gann24_3;
 //BA.debugLineNum = 80;BA.debugLine="Public timestamp As ULong";
b4r_main::_timestamp = 0L;
 //BA.debugLineNum = 81;BA.debugLine="End Sub";
}
void b4r_main::_readsensor(){
const UInt cp = B4R::StackMemory::cp;
 //BA.debugLineNum = 205;BA.debugLine="Public Sub ReadSensor";
 //BA.debugLineNum = 207;BA.debugLine="RunNative(\"setup\",Null)";
Common_RunNative(setup,Common_Null);
 //BA.debugLineNum = 208;BA.debugLine="ReadWeather(0)";
_readweather((Byte) (0));
...
B4R::B4RString be_ann111_4;
 //BA.debugLineNum = 166;BA.debugLine="Sub ReadWeather(tag As Byte)";
 //BA.debugLineNum = 167;BA.debugLine="RunNative(\"ReadDHT22\",Null)";
Common_RunNative(ReadDHT22,Common_Null);
 //BA.debugLineNum = 169;BA.debugLine="Dim localstate As String";
_localstate = B4R::B4RString::EMPTY;
 //BA.debugLineNum = 170;BA.debugLine="Select Case DHT22State";
switch (b4r_main::_dht22state) {
case 0: {
 //BA.debugLineNum = 173;BA.debugLine="localstate = \"OK\"";
_localstate = be_ann97_2.wrap("OK");
 break; }
case 1: {
 //BA.debugLineNum = 176;BA.debugLine="localstate = \"TIMEOUT\"";
_localstate = be_ann99_2.wrap("TIMEOUT");
 break; }
case 2: {
 //BA.debugLineNum = 179;BA.debugLine="localstate = \"CHECKSUM\"";
_localstate = be_ann101_2.wrap("CHECKSUM");
 break; }
}
;
 //BA.debugLineNum = 182;BA.debugLine="If WiFi.IsConnected Then";
if (b4r_main::_wifi->getIsConnected()) { 
 //BA.debugLineNum = 183;BA.debugLine="If localstate = \"OK\" And IsNumber(DHT22Temp) The";
if ((_localstate)->equals(be_ann104_3.wrap("OK")) && B4R::__c->IsNumber(B4R::B4RString::fromNumber((Double)(b4r_main::_dht22temp)))) { 
 //BA.debugLineNum = 185;BA.debugLine="timelib.initialize(\"pool.ntp.org\",0)";
b4r_main::_timelib->initialize(be_ann105_4.wrap("pool.ntp.org"),0);
 //BA.debugLineNum = 186;BA.debugLine="timestamp = timelib.timestamp";
b4r_main::_timestamp = b4r_main::_timelib->timestamp();
 //BA.debugLineNum = 187;BA.debugLine="If timestamp <> 0 Then";
if (b4r_main::_timestamp!=0) { 
 //BA.debugLineNum = 188;BA.debugLine="Dim s As String";
_s = B4R::B4RString::EMPTY;
 //BA.debugLineNum = 189;BA.debugLine="s = JoinStrings(Array As String(localstate,\"|\"";
_s = B4R::__c->JoinStrings(be_ann109_143e2.create(be_ann109_143e1,25,100,_localstate,be_ann109_12.wrap("|"),B4R::B4RString::fromNumber((Double)(b4r_main::_dht22temp)),be_ann109_16.wrap("|"),B4R::B4RString::fromNumber((Double)(b4r_main::_dht22hum)),be_ann109_20.wrap("|"),B4R::B4RString::fromNumber((Long)(b4r_main::_dht22perception)),be_ann109_24.wrap("|"),B4R::B4RString::fromNumber((Long)(b4r_main::_dht22comfortstatus)),be_ann109_28.wrap("|"),B4R::B4RString::fromNumber((Double)(b4r_main::_dht22heatindex)),be_ann109_32.wrap("|"),B4R::B4RString::fromNumber((Double)(b4r_main::_dht22dewpoint)),be_ann109_36.wrap("|"),B4R::__c->NumberFormat(b4r_main::_timelib->getyear(b4r_main::_timestamp),(Byte) (2),(Byte) (0)),be_ann109_54.wrap("-"),B4R::__c->NumberFormat(b4r_main::_timelib->getmonth(b4r_main::_timestamp),(Byte) (2),(Byte) (0)),be_ann109_72.wrap("-"),B4R::__c->NumberFormat(b4r_main::_timelib->getday(b4r_main::_timestamp),(Byte) (2),(Byte) (0)),be_ann109_90.wrap("|"),B4R::__c->NumberFormat(b4r_main::_timelib->gethour(b4r_main::_timestamp),(Byte) (2),(Byte) (0)),be_ann109_108.wrap(":"),B4R::__c->NumberFormat(b4r_main::_timelib->getminute(b4r_main::_timestamp),(Byte) (2),(Byte) (0)),be_ann109_126.wrap(":"),B4R::__c->NumberFormat(b4r_main::_timelib->getseconds(b4r_main::_timestamp),(Byte) (2),(Byte) (0))));
 //BA.debugLineNum = 193;BA.debugLine="Log(\"TempHumid to MQTT: \",s)";
B4R::Common::LogHelper(2,102,F("TempHumid to MQTT: "),101,_s->data);
 //BA.debugLineNum = 194;BA.debugLine="MQTT.Publish(\"TempHumid\",s)";
b4r_main::_mqtt->Publish(be_ann111_4.wrap("TempHumid"),(_s)->GetBytes());
 };
 };
 };
 //BA.debugLineNum = 200;BA.debugLine="If tag = 0 Then";
if (_tag==0) { 
 //BA.debugLineNum = 201;BA.debugLine="CallSubPlus(\"ReadWeather\",60000,0)";
