...
b4r_main::_d6->Initialize(b4r_main::_d1pins->D6,Pin_MODE_OUTPUT);
 //BA.debugLineNum = 86;BA.debugLine="Log(\"Stopping access point\")";
B4R::Common::LogHelper(1,102,F("Stopping access point"));
 //BA.debugLineNum = 87;BA.debugLine="RunNative(\"SetSTA\", Null)";
...
const UInt cp = B4R::StackMemory::cp;
 //BA.debugLineNum = 150;BA.debugLine="Sub ConnectToWifi";
 //BA.debugLineNum = 151;BA.debugLine="WiFi.Connect2(WiFiSSID, WiFiPassword)";
...
if (b4r_main::_wifi->getIsConnected()) { 
 //BA.debugLineNum = 154;BA.debugLine="Log(\"Connected to \",WiFiSSID,\" network, Local IP";
...
b4r_main::_mqtt->Subscribe(be_ann59_4.wrap("TempHumid"),(Byte) (0));
 //BA.debugLineNum = 121;BA.debugLine="MQTT.Subscribe(\"MQ7\", 0)";
b4r_main::_mqtt->Subscribe(be_ann60_4.wrap("MQ7"),(Byte) (0));
 };
...
const UInt cp = B4R::StackMemory::cp;
 //BA.debugLineNum = 143;BA.debugLine="Sub mqtt_Disconnected";
 //BA.debugLineNum = 144;BA.debugLine="pin16.DigitalWrite(True)";
b4r_main::_pin16->DigitalWrite(Common_True);
 //BA.debugLineNum = 145;BA.debugLine="Log(\"Disconnected from broker\")";
B4R::Common::LogHelper(1,102,F("Disconnected from broker"));
 //BA.debugLineNum = 146;BA.debugLine="MQTT.Close";
b4r_main::_mqtt->Close();
 //BA.debugLineNum = 147;BA.debugLine="MQTT_Connect(0)";
_mqtt_connect((Byte) (0));
...
const UInt cp = B4R::StackMemory::cp;
B4R::Object be_ann65_8;
B4R::B4RString be_ann66_3;
B4R::B4RString be_ann67_3;
B4R::B4RString be_ann68_4;
B4R::B4RString be_ann68_6;
...
B4R::Common::LogHelper(4,102,F("Message arrived. Topic="),101,_topic->data,102,F(" Payload="),100,be_ann65_8.wrapPointer(_payload));
 //BA.debugLineNum = 129;BA.debugLine="If Topic = \"TempHumid\" Then";
if ((_topic)->equals(be_ann66_3.wrap("TempHumid"))) { 
 //BA.debugLineNum = 130;BA.debugLine="If Payload = \"Restart controller\" Then";
if ((_payload)->equals((be_ann67_3.wrap("Restart controller"))->GetBytes())) { 
 //BA.debugLineNum = 131;BA.debugLine="MQTT.Publish(\"TempHumid\",\"*Restarting relay by";
b4r_main::_mqtt->Publish(be_ann68_4.wrap("TempHumid"),(be_ann68_6.wrap("*Restarting relay by remote"))->GetBytes());
 //BA.debugLineNum = 132;BA.debugLine="ESP.Restart";
b4r_main::_esp->Restart();
 };
 }else if((_topic)->equals(be_ann71_3.wrap("MQ7"))) { 
 //BA.debugLineNum = 135;BA.debugLine="If Payload = \"Read voltage\" Then";
if ((_payload)->equals((be_ann72_3.wrap("Read voltage"))->GetBytes())) { 
 //BA.debugLineNum = 136;BA.debugLine="Dim s As String";
_s = B4R::B4RString::EMPTY;
 //BA.debugLineNum = 137;BA.debugLine="s = JoinStrings(Array As String(\"readVoltage|\",";
_s = B4R::__c->JoinStrings(be_ann74_13e2.create(be_ann74_13e1,2,100,be_ann74_10.wrap("readVoltage|"),B4R::B4RString::fromNumber((Long)(b4r_main::_readvoltage))));
 //BA.debugLineNum = 138;BA.debugLine="MQTT.Publish(\"MQ7\",s)";
...
const UInt cp = B4R::StackMemory::cp;
 //BA.debugLineNum = 233;BA.debugLine="Sub Preparation1(tag As Byte)";
 //BA.debugLineNum = 234;BA.debugLine="Log(\"Turn the heater fully on\")";
B4R::Common::LogHelper(1,102,F("Turn the heater fully on"));
 //BA.debugLineNum = 235;BA.debugLine="MQ7Pin.AnalogWrite(1024) ' HIGH = 1024";
b4r_main::_mq7pin->AnalogWrite((UInt) (1024));
 //BA.debugLineNum = 236;BA.debugLine="Log(\"Heat for 1 min\")";
B4R::Common::LogHelper(1,102,F("Heat for 1 min"));
 //BA.debugLineNum = 237;BA.debugLine="CallSubPlus(\"Preparation2\",60000,0)";
...
const UInt cp = B4R::StackMemory::cp;
 //BA.debugLineNum = 240;BA.debugLine="Sub Preparation2(tag As Byte)";
 //BA.debugLineNum = 241;BA.debugLine="Log(\"Now reducing the heating power: turn the hea";
B4R::Common::LogHelper(1,102,F("Now reducing the heating power: turn the heater to approx 1.5V"));
 //BA.debugLineNum = 242;BA.debugLine="MQ7Pin.AnalogWrite(307.2) ' 1024x1500/5000; 1024";
b4r_main::_mq7pin->AnalogWrite((UInt) (307.2));
 //BA.debugLineNum = 243;BA.debugLine="Log(\"Heat for 90 sec\")";
B4R::Common::LogHelper(1,102,F("Heat for 90 sec"));
 //BA.debugLineNum = 244;BA.debugLine="CallSubPlus(\"ReadSensor1\",90000,0)";
...
const UInt cp = B4R::StackMemory::cp;
 //BA.debugLineNum = 247;BA.debugLine="Sub ReadSensor1(tag As Byte)";
 //BA.debugLineNum = 248;BA.debugLine="Log(\"We need to read the sensor at 5V, but must n";
B4R::Common::LogHelper(1,102,F("We need to read the sensor at 5V, but must not let it heat up. So hurry!"));
 //BA.debugLineNum = 249;BA.debugLine="MQ7Pin.AnalogWrite(1024)";
b4r_main::_mq7pin->AnalogWrite((UInt) (1024));
 //BA.debugLineNum = 250;BA.debugLine="Log(\"Delay for 50 milli\")";
B4R::Common::LogHelper(1,102,F("Delay for 50 milli"));
 //BA.debugLineNum = 251;BA.debugLine="CallSubPlus(\"ReadSensor2\",50,0) ' Getting an anal";
...
UInt _rawvoltage = 0;
B4R::B4RString* _s = B4R::B4RString::EMPTY;
B4R::B4RString* be_ann181_11e1[1];
B4R::Array be_ann181_11e2;
B4R::B4RString be_ann184_4;
 //BA.debugLineNum = 254;BA.debugLine="Sub ReadSensor2(tag As Byte)";
 //BA.debugLineNum = 255;BA.debugLine="Dim rawvoltage As UInt = MQ7Pin.AnalogRead / 2";
_rawvoltage = (UInt) (b4r_main::_mq7pin->AnalogRead()/(Double)2);
 //BA.debugLineNum = 257;BA.debugLine="Log(\"*************************\")";
B4R::Common::LogHelper(1,102,F("*************************"));
 //BA.debugLineNum = 258;BA.debugLine="Log(\"MQ-7 PPM: \",rawvoltage)";
B4R::Common::LogHelper(2,102,F("MQ-7 PPM: "),4,_rawvoltage);
 //BA.debugLineNum = 259;BA.debugLine="readVoltage = rawvoltage";
b4r_main::_readvoltage = _rawvoltage;
 //BA.debugLineNum = 261;BA.debugLine="Dim s As String";
_s = B4R::B4RString::EMPTY;
 //BA.debugLineNum = 262;BA.debugLine="s = JoinStrings(Array As String(rawvoltage))";
_s = B4R::__c->JoinStrings(be_ann181_11e2.create(be_ann181_11e1,1,100,B4R::B4RString::fromNumber((Long)(_rawvoltage))));
 //BA.debugLineNum = 263;BA.debugLine="Log(\"Sending ppm via MQTT: \",s)";
B4R::Common::LogHelper(2,102,F("Sending ppm via MQTT: "),101,_s->data);
 //BA.debugLineNum = 264;BA.debugLine="If WiFi.IsConnected Then";
if (b4r_main::_wifi->getIsConnected()) { 
 //BA.debugLineNum = 265;BA.debugLine="MQTT.Publish(\"MQ7\",s)";
b4r_main::_mqtt->Publish(be_ann184_4.wrap("MQ7"),(_s)->GetBytes());
 };
 //BA.debugLineNum = 268;BA.debugLine="If rawvoltage <= 100 Then";
if (_rawvoltage<=100) { 
 //BA.debugLineNum = 269;BA.debugLine="Log(\"Air-Quality: CO perfect\")";
B4R::Common::LogHelper(1,102,F("Air-Quality: CO perfect"));
 }else if(((_rawvoltage>100) && (_rawvoltage<400)) || _rawvoltage==400) { 
 //BA.debugLineNum = 271;BA.debugLine="Log(\"Air-Quality: CO normal\")";
B4R::Common::LogHelper(1,102,F("Air-Quality: CO normal"));
 }else if(((_rawvoltage>400) && (_rawvoltage<900)) || _rawvoltage==900) { 
 //BA.debugLineNum = 273;BA.debugLine="Log(\"Air-Quality: CO high\")";
B4R::Common::LogHelper(1,102,F("Air-Quality: CO high"));
 }else if(_rawvoltage>900) { 
 //BA.debugLineNum = 275;BA.debugLine="Log(\"Air-Quality: ALARM CO very high\")";
B4R::Common::LogHelper(1,102,F("Air-Quality: ALARM CO very high"));
 }else {
 //BA.debugLineNum = 277;BA.debugLine="Log(\"MQ-7 - cant read any value - check the sens";
B4R::Common::LogHelper(1,102,F("MQ-7 - cant read any value - check the sensor!"));
 };
 //BA.debugLineNum = 279;BA.debugLine="Log(\"*************************\")";
B4R::Common::LogHelper(1,102,F("*************************"));
 //BA.debugLineNum = 281;BA.debugLine="CallSubPlus(\"Preparation1\",1000,0)";
...
B4R::B4RString* _s = B4R::B4RString::EMPTY;
B4R::B4RString be_ann150_12;
B4R::B4RString be_ann150_16;
B4R::B4RString be_ann150_20;
B4R::B4RString be_ann150_24;
B4R::B4RString be_ann150_28;
B4R::B4RString be_ann150_32;
B4R::B4RString* be_ann150_35e1[13];
B4R::Array be_ann150_35e2;
B4R::B4RString be_ann152_4;
 //BA.debugLineNum = 160;BA.debugLine="Sub ReadWeather(tag As Byte)";
 //BA.debugLineNum = 161;BA.debugLine="RunNative(\"ReadDHT22\",Null)";
Common_RunNative(ReadDHT22,Common_Null);
 //BA.debugLineNum = 163;BA.debugLine="Dim localstate As String";
_localstate = B4R::B4RString::EMPTY;
 //BA.debugLineNum = 164;BA.debugLine="Select Case DHT22State";
switch (b4r_main::_dht22state) {
case 0: {
 //BA.debugLineNum = 167;BA.debugLine="localstate = \"OK\"";
_localstate = be_ann98_2.wrap("OK");
 break; }
case 1: {
 //BA.debugLineNum = 169;BA.debugLine="localstate = \"TIMEOUT\"";
_localstate = be_ann100_2.wrap("TIMEOUT");
 break; }
case 2: {
 //BA.debugLineNum = 173;BA.debugLine="localstate = \"CHECKSUM\"";
_localstate = be_ann102_2.wrap("CHECKSUM");
 break; }
}
;
 //BA.debugLineNum = 176;BA.debugLine="Dim localperception As String";
_localperception = B4R::B4RString::EMPTY;
 //BA.debugLineNum = 177;BA.debugLine="Select Case DHT22Perception";
switch (b4r_main::_dht22perception) {
case 0: {
 //BA.debugLineNum = 179;BA.debugLine="localperception = \"Feels like the western US, a";
_localperception = be_ann107_2.wrap("Feels like the western US, a bit dry to some");
 break; }
case 1: {
 //BA.debugLineNum = 181;BA.debugLine="localperception = \"Very comfortable\"";
_localperception = be_ann109_2.wrap("Very comfortable");
 break; }
case 2: {
 //BA.debugLineNum = 183;BA.debugLine="localperception = \"Comfortable\"";
_localperception = be_ann111_2.wrap("Comfortable");
 break; }
case 3: {
 //BA.debugLineNum = 185;BA.debugLine="localperception = \"OK but everyone perceives th";
_localperception = be_ann113_2.wrap("OK but everyone perceives the humidity at upper limit");
 break; }
case 4: {
 //BA.debugLineNum = 187;BA.debugLine="localperception = \"Somewhat uncomfortable for m";
_localperception = be_ann115_2.wrap("Somewhat uncomfortable for most people at upper limit");
 break; }
case 5: {
 //BA.debugLineNum = 189;BA.debugLine="localperception = \"Very humid, quite uncomforta";
_localperception = be_ann117_2.wrap("Very humid, quite uncomfortable");
 break; }
case 6: {
 //BA.debugLineNum = 191;BA.debugLine="localperception = \"Extremely uncomfortable, opp";
_localperception = be_ann119_2.wrap("Extremely uncomfortable, oppressive");
 break; }
case 7: {
 //BA.debugLineNum = 193;BA.debugLine="localperception = \"Severely high, even deadly f";
_localperception = be_ann121_2.wrap("Severely high, even deadly for asthma related illnesses");
 break; }
}
;
 //BA.debugLineNum = 196;BA.debugLine="Dim localcomfortstatus As String";
_localcomfortstatus = B4R::B4RString::EMPTY;
 //BA.debugLineNum = 197;BA.debugLine="Select Case DHT22ComfortStatus";
switch (b4r_main::_dht22comfortstatus) {
case 0: {
 //BA.debugLineNum = 199;BA.debugLine="localcomfortstatus = \"OK\"";
_localcomfortstatus = be_ann126_2.wrap("OK");
 break; }
case 1: {
 //BA.debugLineNum = 201;BA.debugLine="localcomfortstatus = \"Too hot\"";
_localcomfortstatus = be_ann128_2.wrap("Too hot");
 break; }
case 2: {
 //BA.debugLineNum = 203;BA.debugLine="localcomfortstatus = \"Too cold\"";
_localcomfortstatus = be_ann130_2.wrap("Too cold");
 break; }
case 4: {
 //BA.debugLineNum = 205;BA.debugLine="localcomfortstatus = \"Too dry\"";
_localcomfortstatus = be_ann132_2.wrap("Too dry");
 break; }
case 5: {
 //BA.debugLineNum = 207;BA.debugLine="localcomfortstatus = \"Hot and dry\"";
_localcomfortstatus = be_ann134_2.wrap("Hot and dry");
 break; }
case 6: {
 //BA.debugLineNum = 209;BA.debugLine="localcomfortstatus = \"Cold and dry\"";
_localcomfortstatus = be_ann136_2.wrap("Cold and dry");
 break; }
case 8: {
 //BA.debugLineNum = 211;BA.debugLine="localcomfortstatus = \"Too humid\"";
_localcomfortstatus = be_ann138_2.wrap("Too humid");
 break; }
case 9: {
 //BA.debugLineNum = 213;BA.debugLine="localcomfortstatus = \"Hot and humid\"";
_localcomfortstatus = be_ann140_2.wrap("Hot and humid");
 break; }
case 10: {
 //BA.debugLineNum = 215;BA.debugLine="localcomfortstatus = \"Cold and humid\"";
_localcomfortstatus = be_ann142_2.wrap("Cold and humid");
 break; }
default: {
 //BA.debugLineNum = 217;BA.debugLine="localcomfortstatus = \"Unknown\"";
_localcomfortstatus = be_ann144_2.wrap("Unknown");
 break; }
}
;
 //BA.debugLineNum = 220;BA.debugLine="Log(\"State: \", localstate, \" Temp: \", DHT22Temp,";
B4R::Common::LogHelper(15,102,F("State: "),101,_localstate->data,102,F(" Temp: "),7,(double)(b4r_main::_dht22temp),102,F(" ºF Humidity: "),7,(double)(b4r_main::_dht22hum),102,F(" % Perception: "),101,_localperception->data,102,F(" Comfort Status: "),101,_localcomfortstatus->data,102,F(" HeatIndex: "),7,(double)(b4r_main::_dht22heatindex),102,F(" ºF Dew Point: "),7,(double)(b4r_main::_dht22dewpoint),102,F(" ºF"));
 //BA.debugLineNum = 221;BA.debugLine="If WiFi.IsConnected Then";
if (b4r_main::_wifi->getIsConnected()) { 
 //BA.debugLineNum = 222;BA.debugLine="If IsNumber(DHT22Temp) Then";
if (B4R::__c->IsNumber(B4R::B4RString::fromNumber((Double)(b4r_main::_dht22temp)))) { 
 //BA.debugLineNum = 223;BA.debugLine="Dim s As String";
_s = B4R::B4RString::EMPTY;
 //BA.debugLineNum = 224;BA.debugLine="s = JoinStrings(Array As String(localstate,\"|\",";
_s = B4R::__c->JoinStrings(be_ann150_35e2.create(be_ann150_35e1,13,100,_localstate,be_ann150_12.wrap("|"),B4R::B4RString::fromNumber((Double)(b4r_main::_dht22temp)),be_ann150_16.wrap("|"),B4R::B4RString::fromNumber((Double)(b4r_main::_dht22hum)),be_ann150_20.wrap("|"),B4R::B4RString::fromNumber((Long)(b4r_main::_dht22perception)),be_ann150_24.wrap("|"),B4R::B4RString::fromNumber((Long)(b4r_main::_dht22comfortstatus)),be_ann150_28.wrap("|"),B4R::B4RString::fromNumber((Double)(b4r_main::_dht22heatindex)),be_ann150_32.wrap("|"),B4R::B4RString::fromNumber((Double)(b4r_main::_dht22dewpoint))));
 //BA.debugLineNum = 225;BA.debugLine="Log(\"Sending TempHumid to MQTT: \",s)";
B4R::Common::LogHelper(2,102,F("Sending TempHumid to MQTT: "),101,_s->data);
 //BA.debugLineNum = 226;BA.debugLine="MQTT.Publish(\"TempHumid\",s)";
b4r_main::_mqtt->Publish(be_ann152_4.wrap("TempHumid"),(_s)->GetBytes());
 };
 };
 //BA.debugLineNum = 230;BA.debugLine="CallSubPlus(\"ReadWeather\",5000,0)";
